...
""".strip(),
    ...
    "is": "Language-specific guidance:\n- Use standard Icelandic consistently.\n- Use Latin orthography as the primary writing system and preserve its diacritics or script-specific spelling.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
...
- Preserve Azerbaijani diacritics and standard Türkiye/Azerbaijan distinctions only when explicitly taught.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
    "kk": "Language-specific guidance:\n- Use standard Kazakh consistently.\n- Use Cyrillic orthography as the primary writing system and preserve its diacritics or script-specific spelling.
- Preserve Kazakh-specific vocabulary and case/agglutinative morphology; do not substitute Russian forms.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
...
- Use standard Bosnian vocabulary and preserve Latin orthography and diacritics.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
    ...
    "as": "Language-specific guidance:\n- Use standard Assamese consistently.\n- Use Assamese orthography as the primary writing system and preserve its diacritics or script-specific spelling.
- Use Assamese script naturally and preserve Assamese vocabulary rather than substituting Bengali forms.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
...
- Preserve Belarusian orthography and do not substitute Russian vocabulary or grammar.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
    ...
    "or": "Language-specific guidance:\n- Use standard Odia consistently.\n- Use Odia orthography as the primary writing system and preserve its diacritics or script-specific spelling.
- Use Odia script naturally and preserve standard spelling and postpositional/verb patterns.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
...
- Use the project's Suri curriculum conventions consistently; do not infer regional variants without explicit source content.\n- Pay close attention to grammatical agreement, inflection, natural word order, and register appropriate to the learner level.",
