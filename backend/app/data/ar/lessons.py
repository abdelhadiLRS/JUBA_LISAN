...
ARABIC_A1_CONTENT_SEEDS: tuple[ArabicA1ContentSeed, ...] = (
    ...
    ArabicA1ContentSeed("a1-u2-w2-d2", ("هذا كتابي.", "هذه حقيبتي.", "هذا بيتنا.", "هذه غرفتنا."), ("هذا كتابي الجديد.", "هذه حقيبتي الصغيرة."), "حدد صاحب الأشياء باستخدام ضمير الملكية.", "صف أربعة أشياء تملكها أو تملكها أسرتك."),
    ...
    ArabicA1ContentSeed("a1-u8-w2-d3", ("مرحبًا، ما اسمك؟", "أنا من الجزائر.", "ماذا تعمل؟", "أين تسكن؟"), ("مرحبًا، اسمي علي وأنا من الجزائر.", "أسكن في المدينة وأعمل في شركة."), "استخرج معلومات التعارف الأساسية.", "اكتب حوار تعارف من ستة أدوار."),
    ArabicA1ContentSeed("a1-u8-w2-d4", ("ماذا تفعل صباحًا؟", "أدرس العربية.", "أين تذهب؟", "أذهب إلى الجامعة."), ("أدرس العربية صباحًا وأذهب إلى الجامعة.", "أعود إلى البيت مساءً."), "استخرج الروتين والمكان.", "اكتب فقرة تجمع التعارف والروتين."),
