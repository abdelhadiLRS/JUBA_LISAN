...
AssessmentQuestion(id="nl-a1-013",skill="vocabulary",difficulty="A1",question="Wat betekent 'avond'?",options=["het einde van de dag","het begin van de week","een vervoermiddel","een beroep"],correct="het einde van de dag"),
    ...
    AssessmentQuestion(id="nl-a2-009",skill="grammar",difficulty="A2",question="Welke zin staat in de verleden tijd?",options=["Gisteren ging ik naar de winkel.","Gisteren ga ik naar de winkel.","Gisteren zal ik naar de winkel gaan.","Gisteren naar de winkel gaan."],correct="Gisteren ging ik naar de winkel."),
    AssessmentQuestion(id="nl-a2-010",skill="vocabulary",difficulty="A2",question="Wat betekent 'vertraging'?",options=["iets dat later komt dan gepland","een reservering","een adres","een betaling"],correct="iets dat later komt dan gepland"),
    AssessmentQuestion(id="nl-a2-011",skill="reading",difficulty="A2",question="Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",options=["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],correct="Om zes uur."),
    AssessmentQuestion(id="nl-a2-012",skill="grammar",difficulty="A2",question="Kies de juiste vorm met 'moeten'.",options=["Ik moet werken.","Ik moet werkt.","Ik moet gewerkt.","Ik moeten werken."],correct="Ik moet werken."),
    AssessmentQuestion(id="nl-b1-005",skill="grammar",difficulty="B1",question="Welke betrekkelijke bijzin is correct?",options=["Dit is het boek dat ik gisteren kocht.","Dit is het boek dat ik gisteren kopen.","Dit is het boek die ik gisteren kocht.","Dit is het boek dat ik kocht het."],correct="Dit is het boek dat ik gisteren kocht."),
    ...
    AssessmentQuestion(id="nl-b2-005",skill="grammar",difficulty="B2",question="Welke zin drukt toegeving uit?",options=["Hoewel het regende, gingen we wandelen.","Omdat het regende, gingen we wandelen.","Zodra het regende, gingen we wandelen.","Als het regende, gingen we gisteren wandelen."],correct="Hoewel het regende, gingen we wandelen."),
    ...
    AssessmentQuestion(id="nl-a2-006",skill="vocabulary",difficulty="A2",question="Wat betekent 'vertraging'?",options=["iets dat later komt dan gepland","een reservering","een adres","een betaling"],correct="iets dat later komt dan gepland"),
    AssessmentQuestion(id="nl-a2-007",skill="reading",difficulty="A2",question="Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",options=["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],correct="Om zes uur."),
    AssessmentQuestion(id="nl-a2-008",skill="grammar",difficulty="A2",question="Welke zin is correct?",options=["Ik wil Nederlands leren.","Ik wil Nederlands leert.","Ik wil Nederlands geleerd gisteren.","Ik wil Nederlands lerenen."],correct="Ik wil Nederlands leren."),
    AssessmentQuestion(id="nl-b1-005",skill="grammar",difficulty="B1",question="Welke betrekkelijke bijzin is correct?",options=["Dit is het boek dat ik heb gekocht.","Dit is het boek dat ik gekocht heb het.","Dit is het boek die ik heb gekocht.","Dit is het boek dat heb ik gekocht."],correct="Dit is het boek dat ik heb gekocht."),
    AssessmentQuestion(id="nl-b1-006",skill="vocabulary",difficulty="B1",question="Wat betekent 'uitdaging'?",options=["iets waarvoor inspanning nodig is","een beloning","een vakantie","een adres"],correct="iets waarvoor inspanning nodig is"),
    AssessmentQuestion(id="nl-b1-007",skill="reading",difficulty="B1",question="Lees: 'De vergadering werd uitgesteld omdat de directeur ziek was.' Waarom werd de vergadering uitgesteld?",options=["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],correct="Omdat de directeur ziek was."),
    AssessmentQuestion(id="nl-b1-008",skill="grammar",difficulty="B1",question="Welke woordvolgorde is correct?",options=["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],correct="Gisteren kocht ik een nieuwe computer."),
    ...
    AssessmentQuestion(id="nl-c1-008",skill="grammar",difficulty="C1",question="Welke passieve constructie is correct?",options=["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitvoerde in drie fasen."],correct="Het onderzoek werd in drie fasen uitgevoerd."),
    AssessmentQuestion(id="nl-c2-005",skill="grammar",difficulty="C2",question="Welke formulering drukt epistemische voorzichtigheid uit?",options=["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],correct="Het kan niet worden uitgesloten dat andere factoren een rol spelen."),
    ...
    AssessmentQuestion(id="nl-c2-007",skill="reading",difficulty="C2",question="Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",options=["Van het feit dat de onderliggende aanname klopt.","Van de lengte van de tekst.","Van een informele stijl.","Van de ouderdom van de gegevens."],correct="Van het feit dat de onderliggende aanname klopt."),
    AssessmentQuestion(id="nl-c2-008",skill="grammar",difficulty="C2",question="Welke formulering is het meest precies?",options=["De resultaten laten geen eenduidige generalisatie toe zonder aanvullende gegevens.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren toe zonder aanvullende.","De resultaten laten een zekere generalisatie toe zonder analyse."],correct="De resultaten laten geen eenduidige generalisatie toe zonder aanvullende gegevens.")


    AssessmentQuestion(id="nl-b2-005",skill="grammar",difficulty="B2",question="Welke zin drukt een tegenstelling correct uit?",options=["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],correct="Hoewel het regende, gingen we wandelen."),
    AssessmentQuestion(id="nl-b2-006",skill="vocabulary",difficulty="B2",question="Wat betekent 'voorspellen'?",options=["zeggen wat waarschijnlijk zal gebeuren","iets uit het verleden uitleggen","een regel veranderen","een afspraak annuleren"],correct="zeggen wat waarschijnlijk zal gebeuren"),
    AssessmentQuestion(id="nl-b2-007",skill="reading",difficulty="B2",question="Lees: 'De resultaten wijzen op verbetering, maar verder onderzoek blijft nodig.' Wat is de conclusie?",options=["Verder onderzoek is nodig.","Het onderzoek is mislukt.","Er is geen verbetering.","Alle resultaten zijn zeker."],correct="Verder onderzoek is nodig."),
    AssessmentQuestion(id="nl-b2-008",skill="grammar",difficulty="B2",question="Kies de correcte indirecte vraag.",options=["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],correct="Ik weet niet wanneer de vergadering begint."),
    AssessmentQuestion(id="nl-c1-005",skill="grammar",difficulty="C1",question="Welke formulering past het best in een academische tekst?",options=["De resultaten suggereren dat het effect beperkt is.","De resultaten suggereren het effect dat beperkt is.","De resultaten suggereert dat het effect beperkt is.","De resultaten suggereren dat effect beperkt."],correct="De resultaten suggereren dat het effect beperkt is."),
    AssessmentQuestion(id="nl-c1-006",skill="vocabulary",difficulty="C1",question="Wat betekent 'wezenlijk' in een academische context?",options=["belangrijk of fundamenteel","toevallig","tijdelijk","informeel"],correct="belangrijk of fundamenteel"),
    AssessmentQuestion(id="nl-c1-007",skill="reading",difficulty="C1",question="Lees: 'Correlatie bewijst op zichzelf geen oorzakelijk verband.' Wat wordt niet bewezen?",options=["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],correct="Dat het ene verschijnsel het andere veroorzaakt."),
    AssessmentQuestion(id="nl-c1-008",skill="grammar",difficulty="C1",question="Welke passieve constructie is correct?",options=["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werden in drie fasen uitgevoerd."],correct="Het onderzoek werd in drie fasen uitgevoerd."),
    ...
    AssessmentQuestion(id="nl-c2-006",skill="vocabulary",difficulty="C2",question="Wat betekent 'dubbelzinnig'?",options=["vatbaar voor meer dan één interpretatie","volledig ondubbelzinnig","zeer kort","gemakkelijk meetbaar"],correct="vatbaar voor meer dan één interpretatie"),
    AssessmentQuestion(id="nl-c2-007",skill="reading",difficulty="C2",question="Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",options=["Of de onderliggende aanname klopt.","Of het argument kort is.","Of de tekst informeel is.","Of de gegevens oud zijn."],correct="Of de onderliggende aanname klopt."),
    AssessmentQuestion(id="nl-c2-008",skill="grammar",difficulty="C2",question="Welke formulering is het meest precies?",options=["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren toe zonder aanvullende.","De resultaten laten een zekere generalisatie toe zonder analyse."],correct="De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.")
...
AssessmentQuestion(id="nl-a1-010",skill="vocabulary",difficulty="A1",question="Wat betekent 'appel'?",options=["een vrucht","een voertuig","een gebouw","een meubel"],correct="een vrucht"),
AssessmentQuestion(id="nl-a1-011",skill="reading",difficulty="A1",question="Lees: 'Sofie woont in Utrecht.' Waar woont Sofie?",options=["In Utrecht.","In Rotterdam.","In Groningen.","In Leiden."],correct="In Utrecht."),
AssessmentQuestion(id="nl-a1-012",skill="grammar",difficulty="A1",question="Kies de juiste vorm.",options=["Hij heeft een fiets.","Hij heeft een fiet.","Hij hebben een fiets.","Hij heeft een fietsen."],correct="Hij heeft een fiets.",grammar_slug="hebben"),
AssessmentQuestion(id="nl-a2-005",skill="grammar",difficulty="A2",question="Kies de juiste verleden tijd.",options=["Ik werkte gisteren.","Ik werken gisteren.","Ik gewerkt gisteren.","Ik werk gisteren."],correct="Ik werkte gisteren.",grammar_slug="verleden-tijd"),
AssessmentQuestion(id="nl-a2-006",skill="vocabulary",difficulty="A2",question="Wat betekent 'vertraging'?",options=["iets dat later komt dan gepland","een reservering","een adres","een betaling"],correct="iets dat later komt dan gepland"),
AssessmentQuestion(id="nl-a2-007",skill="reading",difficulty="A2",question="Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",options=["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],correct="Om zes uur."),
AssessmentQuestion(id="nl-a2-008",skill="grammar",difficulty="A2",question="Kies de juiste zin.",options=["Ik moet morgen werken.","Ik moet morgen werk.","Ik moeten morgen werken.","Ik moet morgen gewerkt."],correct="Ik moet morgen werken.",grammar_slug="modale-werkwoorden"),
...
AssessmentQuestion(id="nl-b1-008",skill="grammar",difficulty="B1",question="Kies de juiste woordvolgorde.",options=["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],correct="Gisteren kocht ik een nieuwe computer.",grammar_slug="woordvolgorde"),
AssessmentQuestion(id="nl-b2-005",skill="grammar",difficulty="B2",question="Kies de juiste toegevende bijzin.",options=["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],correct="Hoewel het regende, gingen we wandelen.",grammar_slug="concessieve-zinnen"),
AssessmentQuestion(id="nl-b2-006",skill="vocabulary",difficulty="B2",question="Wat betekent 'voorspellen'?",options=["zeggen wat er waarschijnlijk zal gebeuren","iets uit het verleden uitleggen","een regel veranderen","een afspraak annuleren"],correct="zeggen wat er waarschijnlijk zal gebeuren"),
AssessmentQuestion(id="nl-b2-007",skill="reading",difficulty="B2",question="Lees: 'De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",options=["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek direct stoppen."],correct="De resultaten voorzichtig interpreteren."),
AssessmentQuestion(id="nl-b2-008",skill="grammar",difficulty="B2",question="Kies de juiste indirecte vraag.",options=["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],correct="Ik weet niet wanneer de vergadering begint.",grammar_slug="indirecte-vraag"),
AssessmentQuestion(id="nl-c1-005",skill="grammar",difficulty="C1",question="Kies de meest precieze academische formulering.",options=["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen dat het effect beperkt is.","De resultaten wijzen erop het effect dat beperkt is.","De resultaten wijst erop dat het effect beperkt is."],correct="De resultaten wijzen erop dat het effect beperkt is.",grammar_slug="academische-taal"),
AssessmentQuestion(id="nl-c1-006",skill="vocabulary",difficulty="C1",question="Wat betekent 'wezenlijk' in een academische context?",options=["belangrijk of fundamenteel","toevallig","tijdelijk","informeel"],correct="belangrijk of fundamenteel"),
AssessmentQuestion(id="nl-c1-007",skill="reading",difficulty="C1",question="Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat bewijst correlatie niet?",options=["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],correct="Dat het ene verschijnsel het andere veroorzaakt."),
...
AssessmentQuestion(id="nl-c2-006",skill="vocabulary",difficulty="C2",question="Wat betekent 'dubbelzinnig'?",options=["voor meer dan één uitleg vatbaar","volkomen duidelijk","zeer kort","gemakkelijk meetbaar"],correct="voor meer dan één uitleg vatbaar"),
AssessmentQuestion(id="nl-c2-007",skill="reading",difficulty="C2",question="Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",options=["Of de onderliggende aanname klopt.","Of het argument kort is.","Of de tekst informeel is.","Of de gegevens oud zijn."],correct="Of de onderliggende aanname klopt."),
AssessmentQuestion(id="nl-c2-008",skill="grammar",difficulty="C2",question="Kies de meest precieze academische formulering.",options=["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren toe zonder aanvullende.","De resultaten laten een zekere generalisatie toe zonder analyse."],correct="De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.",grammar_slug="academische-stijl")
...
AssessmentQuestion("nl-a1-011","reading","A1","Lees: 'Lisa woont in Utrecht.' Waar woont Lisa?",["In Utrecht.","In Amsterdam.","In Rotterdam.","In Groningen."],"In Utrecht."),
AssessmentQuestion("nl-a1-012","grammar","A1","Kies de juiste vorm.",["Hij heeft een fiets.","Hij heeft een fietsen.","Hij hebben een fiets.","Hij heeft een fiets zijn."],"Hij heeft een fiets.","hebben"),
...
AssessmentQuestion("nl-a2-008","grammar","A2","Kies de juiste voorzetselcombinatie.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon aan Nederland."],"Ik woon in Nederland.","voorzetsels"),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste bijzin.",["Ik weet dat hij morgen komt.","Ik weet dat komt hij morgen.","Ik weet dat hij morgen komen.","Ik weet hij dat morgen komt."],"Ik weet dat hij morgen komt.","bijzinnen"),
...
AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste concessieve zin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen.","concessieve-bijzin"),
AssessmentQuestion("nl-b2-006","vocabulary","B2","Wat betekent 'voorspellen'?",["inschatten wat waarschijnlijk zal gebeuren","het verleden uitleggen","een regel veranderen","een afspraak annuleren"],"inschatten wat waarschijnlijk zal gebeuren"),
...
AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitvoeren in drie fasen."],"Het onderzoek werd in drie fasen uitgevoerd.","passief"),
...
AssessmentQuestion("nl-a1-010","vocabulary","A1","Wat betekent 'appel'?",["een vrucht","een voertuig","een gebouw","een meubel"],"een vrucht"),
AssessmentQuestion("nl-a1-011","reading","A1","Lees: 'Sofie woont in Utrecht.' Waar woont Sofie?",["In Utrecht.","In Rotterdam.","In Groningen.","In Eindhoven."],"In Utrecht."),
AssessmentQuestion("nl-a1-012","grammar","A1","Kies de juiste vorm.",["Hij heeft een fiets.","Hij heeft een fiets?","Hij hebben een fiets.","Hij heb een fiets."],"Hij heeft een fiets."),
AssessmentQuestion("nl-a2-009","grammar","A2","Kies de juiste voltooide tijd.",["Ik heb gegeten.","Ik heb eten.","Ik heb at.","Ik eten heb."],"Ik heb gegeten."),
AssessmentQuestion("nl-a2-010","vocabulary","A2","Wat betekent 'vertraging'?",["iets dat later komt dan gepland","een reservering","een adres","een betaling"],"iets dat later komt dan gepland"),
AssessmentQuestion("nl-a2-011","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),
AssessmentQuestion("nl-a2-012","grammar","A2","Kies de juiste voorzetselcombinatie.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon aan Nederland."],"Ik woon in Nederland."),
AssessmentQuestion("nl-b1-009","grammar","B1","Kies de juiste betrekkelijke bijzin.",["Dit is het boek dat ik heb gekocht.","Dit is het boek dat ik gekocht heb het.","Dit is het boek die ik heb gekocht.","Dit is het boek dat heeft gekocht ik."],"Dit is het boek dat ik heb gekocht."),
AssessmentQuestion("nl-b1-010","vocabulary","B1","Wat betekent 'uitdaging'?",["iets dat inspanning vereist","een beloning","een vakantie","een adres"],"iets dat inspanning vereist"),
AssessmentQuestion("nl-b1-011","reading","B1","Lees: 'De vergadering werd verplaatst omdat de directeur ziek was.' Waarom werd de vergadering verplaatst?",["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],"Omdat de directeur ziek was."),
AssessmentQuestion("nl-b1-012","grammar","B1","Kies de juiste woordvolgorde.",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],"Gisteren kocht ik een nieuwe computer."),
AssessmentQuestion("nl-b2-009","grammar","B2","Kies de juiste toegevende bijzin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen."),
AssessmentQuestion("nl-b2-010","vocabulary","B2","Wat betekent 'voorspellen'?",["inschatten wat waarschijnlijk zal gebeuren","het verleden uitleggen","een regel veranderen","een afspraak annuleren"],"inschatten wat waarschijnlijk zal gebeuren"),
AssessmentQuestion("nl-b2-011","reading","B2","Lees: 'De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek onmiddellijk beëindigen."],"De resultaten voorzichtig interpreteren."),
AssessmentQuestion("nl-b2-012","grammar","B2","Kies de juiste indirecte vraag.",["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],"Ik weet niet wanneer de vergadering begint."),
AssessmentQuestion("nl-c1-009","grammar","C1","Kies de meest precieze academische formulering.",["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen dat het effect beperkt is.","De resultaten wijst erop dat het effect beperkt is.","De resultaten wijzen erop het effect dat beperkt is."],"De resultaten wijzen erop dat het effect beperkt is."),
AssessmentQuestion("nl-c1-010","vocabulary","C1","Wat betekent 'significant' in een academische context?",["belangrijk of betekenisvol","toevallig","tijdelijk","informeel"],"belangrijk of betekenisvol"),
AssessmentQuestion("nl-c1-011","reading","C1","Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat wordt niet bewezen?",["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],"Dat het ene verschijnsel het andere veroorzaakt."),
AssessmentQuestion("nl-c1-012","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitvoeren in drie fasen."],"Het onderzoek werd in drie fasen uitgevoerd.","passief"),
AssessmentQuestion("nl-c2-009","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen.","epistemische-modaliteit"),
AssessmentQuestion("nl-c2-010","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],"op meer dan één manier te interpreteren"),
AssessmentQuestion("nl-c2-011","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",["Of de onderliggende aanname klopt.","Of het argument kort is.","Of de tekst informeel is.","Of de gegevens oud zijn."],"Of de onderliggende aanname klopt."),
AssessmentQuestion("nl-c2-012","grammar","C2","Kies de meest precieze academische formulering.",["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren zonder aanvullende toe.","De resultaten laten een zekere generalisatie toe zonder analyse."],"De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","academische-stijl")
]
