...
AssessmentQuestion(id="nl-c2-010",skill="vocabulary",difficulty="C2",question="Wat betekent 'weerlegbaar'?",options=["vatbaar voor weerlegging met argumenten of bewijs","onmogelijk om te onderzoeken","volledig onbetwist","zonder betekenis"],correct="vatbaar voor weerlegging met argumenten of bewijs"),
...
AssessmentQuestion(id="nl-c2-020",skill="reading",difficulty="C2",question="Lees: 'De bevindingen zijn robuust binnen deze steekproef, maar de externe validiteit is beperkt.' Wat is beperkt?",options=["De mogelijkheid om de bevindingen naar andere situaties te generaliseren.","De interne consistentie binnen de steekproef.","Het aantal waarnemingen in elk geval.","De nauwkeurigheid van de gebruikte termen."],correct="De mogelijkheid om de bevindingen naar andere situaties te generaliseren.")
    ...
    AssessmentQuestion(id="nl-b1-005",skill="grammar",difficulty="B1",question="Kies de correcte betrekkelijke bijzin.",options=["Dit is het boek dat ik heb gekocht.","Dit is het boek die ik heb gekocht.","Dit is het boek dat ik gekocht.","Dit is het boek ik dat heb gekocht."],correct="Dit is het boek dat ik heb gekocht."),
    AssessmentQuestion(id="nl-b1-006",skill="vocabulary",difficulty="B1",question="Wat betekent 'uitdaging'?",options=["iets waarvoor inspanning nodig is","een beloning","een vakantie","een adres"],correct="iets waarvoor inspanning nodig is"),
    AssessmentQuestion(id="nl-b1-007",skill="reading",difficulty="B1",question="Lees: 'De vergadering werd verplaatst omdat de directeur ziek was.' Waarom werd de vergadering verplaatst?",options=["Omdat de directeur ziek was.","Omdat het kantoor dicht was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],correct="Omdat de directeur ziek was."),
    ...
    AssessmentQuestion(id="nl-b2-006",skill="vocabulary",difficulty="B2",question="Wat betekent 'voorspellen'?",options=["inschatten wat er later zal gebeuren","iets uit het verleden verklaren","een regel veranderen","een afspraak annuleren"],correct="inschatten wat er later zal gebeuren"),
    ...
    AssessmentQuestion(id="nl-c2-006",skill="vocabulary",difficulty="C2",question="Wat betekent 'dubbelzinnig'?",options=["vatbaar voor meer dan één uitleg","volkomen duidelijk","zeer kort","gemakkelijk te meten"],correct="vatbaar voor meer dan één uitleg"),
