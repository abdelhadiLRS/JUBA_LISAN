...
AssessmentQuestion(id="nl-c2-020-r2",skill="reading",difficulty="C2",question="Lees: 'De bevindingen zijn robuust binnen deze steekproef, maar de externe validiteit is beperkt.' Wat is beperkt?",options=["De mogelijkheid om de bevindingen naar andere situaties te generaliseren.","De interne consistentie binnen de steekproef.","Het aantal waarnemingen in elk geval.","De nauwkeurigheid van de gebruikte termen."],correct="De mogelijkheid om de bevindingen naar andere situaties te generaliseren.")
    ...
    AssessmentQuestion(id="nl-a2-005",skill="grammar",difficulty="A2",question="Kies de juiste voltooid tegenwoordige tijd.",options=["Ik heb gisteren gekookt.","Ik heb gisteren koken.","Ik gisteren heb kookte.","Ik heb gisteren kook."],correct="Ik heb gisteren gekookt."),
    AssessmentQuestion(id="nl-a2-006",skill="vocabulary",difficulty="A2",question="Wat betekent ‘vertraging’?",options=["dat iets later komt dan gepland","een reservering","een adres","een betaling"],correct="dat iets later komt dan gepland"),
    ...
    AssessmentQuestion(id="nl-a2-008",skill="grammar",difficulty="A2",question="Kies de juiste voorzetselcombinatie.",options=["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon bij Nederland."],correct="Ik woon in Nederland."),
    AssessmentQuestion(id="nl-b1-005",skill="grammar",difficulty="B1",question="Kies de correcte betrekkelijke bijzin.",options=["Dit is het boek dat ik heb gekocht.","Dit is het boek die ik heb gekocht.","Dit is het boek dat heb ik gekocht.","Dit is het boek ik dat gekocht heb."],correct="Dit is het boek dat ik heb gekocht."),
    AssessmentQuestion(id="nl-b1-006",skill="vocabulary",difficulty="B1",question="Wat betekent ‘uitdaging’?",options=["iets waarvoor je moeite moet doen","een beloning","een vakantie","een adres"],correct="iets waarvoor je moeite moet doen"),
    AssessmentQuestion(id="nl-b1-007",skill="reading",difficulty="B1",question="Lees: ‘De vergadering werd verplaatst omdat de directeur ziek was.’ Waarom werd de vergadering verplaatst?",options=["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],correct="Omdat de directeur ziek was."),
    AssessmentQuestion(id="nl-b1-008",skill="grammar",difficulty="B1",question="Kies de juiste woordvolgorde.",options=["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],correct="Gisteren kocht ik een nieuwe computer."),
    AssessmentQuestion(id="nl-b2-005",skill="grammar",difficulty="B2",question="Kies de correcte toegevende bijzin.",options=["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],correct="Hoewel het regende, gingen we wandelen."),
    AssessmentQuestion(id="nl-b2-006",skill="vocabulary",difficulty="B2",question="Wat betekent ‘voorspellen’?",options=["inschatten wat er in de toekomst zal gebeuren","iets uit het verleden verklaren","een regel veranderen","een afspraak afzeggen"],correct="inschatten wat er in de toekomst zal gebeuren"),
    AssessmentQuestion(id="nl-b2-007",skill="reading",difficulty="B2",question="Lees: ‘De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.’ Wat wordt aanbevolen?",options=["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten aanpassen.","Het onderzoek meteen beëindigen."],correct="De resultaten voorzichtig interpreteren."),
    AssessmentQuestion(id="nl-b2-008",skill="grammar",difficulty="B2",question="Kies de correcte indirecte vraag.",options=["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],correct="Ik weet niet wanneer de vergadering begint."),
    AssessmentQuestion(id="nl-c1-005",skill="grammar",difficulty="C1",question="Kies de meest nauwkeurige academische formulering.",options=["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen dat het effect beperkt is.","De resultaten wijzen erop het effect beperkt is.","De resultaten wijst erop dat het effect beperkt zijn."],correct="De resultaten wijzen erop dat het effect beperkt is."),
    ...
    AssessmentQuestion(id="nl-c1-007",skill="reading",difficulty="C1",question="Lees: ‘Een correlatie bewijst op zichzelf geen oorzakelijk verband.’ Wat bewijst de correlatie niet?",options=["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens bestaan.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],correct="Dat het ene verschijnsel het andere veroorzaakt."),
    AssessmentQuestion(id="nl-c1-008",skill="grammar",difficulty="C1",question="Kies de correcte passieve constructie.",options=["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werden in drie fasen uitgevoerd.","Het onderzoek uitvoeren werd in drie fasen.","Het onderzoek werd in drie fase uitgevoerd."],correct="Het onderzoek werd in drie fasen uitgevoerd."),
    AssessmentQuestion(id="nl-c2-005",skill="grammar",difficulty="C2",question="Welke formulering drukt wetenschappelijke voorzichtigheid uit?",options=["De invloed van andere factoren kan niet worden uitgesloten.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],correct="De invloed van andere factoren kan niet worden uitgesloten."),
    AssessmentQuestion(id="nl-c2-006",skill="vocabulary",difficulty="C2",question="Wat betekent ‘ambigu’?",options=["vatbaar voor meer dan één interpretatie","volkomen eenduidig","zeer kort","gemakkelijk meetbaar"],correct="vatbaar voor meer dan één interpretatie"),
    ...
    AssessmentQuestion(id="nl-c2-008",skill="grammar",difficulty="C2",question="Kies de meest precieze academische formulering.",options=["De bevindingen rechtvaardigen geen stellige conclusie zonder aanvullend bewijs.","De bevindingen rechtvaardigen altijd een conclusie zonder bewijs.","De bevindingen rechtvaardigen geen conclusie aanvullend bewijs.","De bevindingen bewijzen de conclusie zonder analyse."],correct="De bevindingen rechtvaardigen geen stellige conclusie zonder aanvullend bewijs.")
