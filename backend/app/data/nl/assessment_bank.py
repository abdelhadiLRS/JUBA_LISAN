...
AssessmentQuestion("nl-a1-005","grammar","A1","Kies de juiste vraag.",["Waar woon je?","Waar je woont?","Woon waar je?","Waar wonen?"],"Waar woon je?"),
AssessmentQuestion("nl-a1-006","vocabulary","A1","Wat betekent 'appel'?",["een vrucht","een voertuig","een gebouw","een meubel"],"een vrucht"),
AssessmentQuestion("nl-a1-007","reading","A1","Lees: 'Pieter woont in Utrecht.' Waar woont Pieter?",["In Utrecht.","In Rotterdam.","In Groningen.","In Leiden."],"In Utrecht."),
AssessmentQuestion("nl-a1-008","grammar","A1","Kies de juiste vorm.",["Zij heeft een auto.","Zij heeft een autos.","Zij hebben een auto.","Zij heeft een aut."],"Zij heeft een auto."),
...
AssessmentQuestion("nl-a2-008","grammar","A2","Kies de juiste voorzetselcombinatie.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon aan Nederland."],"Ik woon in Nederland."),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste betrekkelijke bijzin.",["Dit is het boek dat ik kocht.","Dit is het boek dat ik kopen.","Dit is het boek die ik kocht.","Dit is het boek dat ik het kocht."],"Dit is het boek dat ik kocht."),
...
AssessmentQuestion("nl-b1-008","grammar","B1","Welke woordvolgorde is correct?",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],"Gisteren kocht ik een nieuwe computer."),
AssessmentQuestion("nl-b2-005","grammar","B2","Welke zin drukt een tegenstelling uit?",["Hoewel het regende, gingen we wandelen.","Omdat het regende, gingen we wandelen.","Zodra het regent, gaan we wandelen.","Als het regent, blijven we thuis."],"Hoewel het regende, gingen we wandelen."),
AssessmentQuestion("nl-b2-006","vocabulary","B2","Wat betekent 'voorspellen'?",["zeggen wat waarschijnlijk zal gebeuren","iets uit het verleden verklaren","een regel veranderen","een afspraak annuleren"],"zeggen wat waarschijnlijk zal gebeuren"),
AssessmentQuestion("nl-b2-007","reading","B2","Lees: 'De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek onmiddellijk stoppen."],"De resultaten voorzichtig interpreteren."),
AssessmentQuestion("nl-b2-008","grammar","B2","Welke indirecte vraag is correct?",["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],"Ik weet niet wanneer de vergadering begint."),
AssessmentQuestion("nl-c1-005","grammar","C1","Welke formulering past het best in een academische tekst?",["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen dat het effect beperkt is.","De resultaten wijst erop dat het effect beperkt is.","De resultaten wijzen erop het effect beperkt."],"De resultaten wijzen erop dat het effect beperkt is."),
AssessmentQuestion("nl-c1-006","vocabulary","C1","Wat betekent 'wezenlijk' in een academische context?",["belangrijk of fundamenteel","toevallig","tijdelijk","informeel"],"belangrijk of fundamenteel"),
AssessmentQuestion("nl-c1-007","reading","C1","Lees: 'Correlatie bewijst op zichzelf geen oorzakelijk verband.' Wat wordt niet bewezen?",["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens bestaan.","Dat de variabelen samenhangen.","Dat er een analyse is uitgevoerd."],"Dat het ene verschijnsel het andere veroorzaakt."),
AssessmentQuestion("nl-c1-008","grammar","C1","Welke passieve constructie is correct?",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitvoeren in drie fasen."],"Het onderzoek werd in drie fasen uitgevoerd."),
AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen."),
AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["vatbaar voor meer dan één interpretatie","volledig eenduidig","zeer kort","gemakkelijk meetbaar"],"vatbaar voor meer dan één interpretatie"),
AssessmentQuestion("nl-c2-007","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname standhoudt.' Waarvan hangt de beoordeling af?",["Van het feit dat de onderliggende aanname standhoudt.","Van de lengte van het argument.","Van een informele stijl.","Van de ouderdom van de gegevens."],"Van het feit dat de onderliggende aanname standhoudt."),
AssessmentQuestion("nl-c2-008","grammar","C2","Welke formulering is het meest precies?",["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren met aanvullende gegevens toe.","De resultaten laten een zekere generalisatie toe zonder analyse."],"De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.")

AssessmentQuestion("nl-a2-005","grammar","A2","Kies de juiste verleden tijd.",["Ik werkte gisteren thuis.","Ik werk gisteren thuis.","Ik werken gisteren thuis.","Ik gewerkt gisteren thuis."],"Ik werkte gisteren thuis.","verleden-tijd"),
AssessmentQuestion("nl-a2-006","vocabulary","A2","Wat betekent 'vertraging'?",["iets dat later komt dan gepland","een reservering","een adres","een betaling"],"iets dat later komt dan gepland"),
AssessmentQuestion("nl-a2-007","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),
AssessmentQuestion("nl-a2-008","grammar","A2","Kies de juiste zin.",["Ik moet morgen werken.","Ik moet morgen werkt.","Ik moet morgen werkte.","Ik moet morgen gewerkt."],"Ik moet morgen werken.","modale-werkwoorden"),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste betrekkelijke bijzin.",["Dit is het boek dat ik heb gekocht.","Dit is het boek dat ik gekocht.","Dit is het boek die ik heb gekocht.","Dit is het boek dat heb ik gekocht."],"Dit is het boek dat ik heb gekocht.","betrekkelijke-bijzin"),
AssessmentQuestion("nl-b1-006","vocabulary","B1","Wat betekent 'uitdaging'?",["iets dat inspanning vereist","een beloning","een vakantie","een adres"],"iets dat inspanning vereist"),
AssessmentQuestion("nl-b1-007","reading","B1","Lees: 'De vergadering werd uitgesteld omdat de directeur ziek was.' Waarom werd de vergadering uitgesteld?",["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],"Omdat de directeur ziek was."),
AssessmentQuestion("nl-b1-008","grammar","B1","Kies de juiste woordvolgorde.",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer ik kocht."],"Gisteren kocht ik een nieuwe computer.","woordvolgorde"),
AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste concessieve zin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen.","concessieve-zinnen"),
...
AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitgevoerd drie fasen."],"Het onderzoek werd in drie fasen uitgevoerd.","passieve-constructie"),
AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt wetenschappelijke voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen.","epistemische-modaliteit"),
AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],"op meer dan één manier te interpreteren"),
...
AssessmentQuestion("nl-a1-009","grammar","A1","Kies de juiste zin.",["Ik woon in Amsterdam.","Ik woont in Amsterdam.","Ik wonen in Amsterdam.","Ik woonen in Amsterdam."],"Ik woon in Amsterdam.","present-tense"),
...
AssessmentQuestion("nl-a1-012","grammar","A1","Kies het juiste lidwoord: '___ boek ligt op tafel.'",["Het","De","Een","Die"],"Het"),
...
AssessmentQuestion("nl-a2-006","vocabulary","A2","Wat betekent 'vertraging'?",["iets dat later komt dan gepland","een reservering","een adres","een betaling"],"iets dat later komt dan gepland"),
AssessmentQuestion("nl-a2-007","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),
AssessmentQuestion("nl-a2-008","grammar","A2","Kies de juiste vorm.",["Ik moet morgen werken.","Ik moet morgen werkt.","Ik moeten morgen werken.","Ik moet morgen gewerkt."],"Ik moet morgen werken.","modal-verbs"),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste bijzin.",["Ik weet dat hij morgen komt.","Ik weet dat hij morgen komen.","Ik weet dat morgen hij komt.","Ik weet hij dat morgen komt."],"Ik weet dat hij morgen komt.","subordinate-clauses"),
AssessmentQuestion("nl-b1-006","vocabulary","B1","Wat betekent 'uitdaging'?",["iets waarvoor je moeite moet doen","een beloning","een vakantie","een adres"],"iets waarvoor je moeite moet doen"),
AssessmentQuestion("nl-b1-007","reading","B1","Lees: 'De vergadering werd uitgesteld omdat de directeur ziek was.' Waarom werd de vergadering uitgesteld?",["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],"Omdat de directeur ziek was."),
AssessmentQuestion("nl-b1-008","grammar","B1","Kies de juiste woordvolgorde.",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer ik kocht."],"Gisteren kocht ik een nieuwe computer.","word-order"),
AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste toegevende bijzin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen.","concessive"),
AssessmentQuestion("nl-b2-006","vocabulary","B2","Wat betekent 'voorspellen'?",["zeggen wat er waarschijnlijk zal gebeuren","iets uit het verleden uitleggen","een regel veranderen","een afspraak annuleren"],"zeggen wat er waarschijnlijk zal gebeuren"),
AssessmentQuestion("nl-b2-007","reading","B2","Lees: 'De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek meteen stoppen."],"De resultaten voorzichtig interpreteren."),
AssessmentQuestion("nl-b2-008","grammar","B2","Kies de juiste indirecte vraag.",["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],"Ik weet niet wanneer de vergadering begint.","indirect-question"),
...
AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd uitvoeren in drie fasen."],"Het onderzoek werd in drie fasen uitgevoerd.","passive"),
AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen.","epistemic-modality"),
AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],"op meer dan één manier te interpreteren"),
AssessmentQuestion("nl-c2-007","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",["Van de juistheid van de onderliggende aanname.","Van de lengte van de tekst.","Van een informele stijl.","Van de ouderdom van de gegevens."],"Van de juistheid van de onderliggende aanname."),
AssessmentQuestion("nl-c2-008","grammar","C2","Kies de meest precieze academische formulering.",["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie zonder gegevens toe.","De resultaten laten geen generaliseren met aanvullende gegevens.","De resultaten laten een zekere generalisatie toe zonder analyse."],"De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","academic-style")

    AssessmentQuestion(id="nl-a2-009",skill="grammar",difficulty="A2",question="Welke zin is correct?",options=["Ik moet morgen werken.","Ik moet morgen werkt.","Ik moet morgen gewerkt.","Ik moet morgen werken."],correct="Ik moet morgen werken."),
    AssessmentQuestion(id="nl-a2-010",skill="reading",difficulty="A2",question="Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",options=["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],correct="Om zes uur."),
    AssessmentQuestion(id="nl-b1-005",skill="grammar",difficulty="B1",question="Welke voorwaardelijke zin is correct?",options=["Als ik tijd heb, ga ik mee.","Als ik tijd heb, ik ga mee.","Als ik had tijd, ga ik mee.","Als ik tijd heb, ging ik mee gisteren."],correct="Als ik tijd heb, ga ik mee."),
    ...
    AssessmentQuestion(id="nl-b2-007",skill="reading",difficulty="B2",question="Lees: 'De resultaten tonen een duidelijke trend, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",options=["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek direct beëindigen."],correct="De resultaten voorzichtig interpreteren."),
    AssessmentQuestion(id="nl-b2-008",skill="grammar",difficulty="B2",question="Welke indirecte vraag is correct?",options=["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],correct="Ik weet niet wanneer de vergadering begint."),
    AssessmentQuestion(id="nl-c1-005",skill="grammar",difficulty="C1",question="Welke formulering past bij academisch Nederlands?",options=["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen dat het effect beperkt is.","De resultaten wijst erop dat het effect beperkt is.","De resultaten wijzen erop het effect beperkt."],correct="De resultaten wijzen erop dat het effect beperkt is."),
    AssessmentQuestion(id="nl-c1-006",skill="vocabulary",difficulty="C1",question="Wat betekent 'wezenlijk' in een academische tekst?",options=["belangrijk of fundamenteel","toevallig","tijdelijk","informeel"],correct="belangrijk of fundamenteel"),
    AssessmentQuestion(id="nl-c1-007",skill="reading",difficulty="C1",question="Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat wordt niet bewezen?",options=["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],correct="Dat het ene verschijnsel het andere veroorzaakt."),
    AssessmentQuestion(id="nl-c1-008",skill="grammar",difficulty="C1",question="Welke passieve constructie is correct?",options=["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd drie fasen uitgevoerd."],correct="Het onderzoek werd in drie fasen uitgevoerd."),
    ...
    AssessmentQuestion(id="nl-c2-007",skill="reading",difficulty="C2",question="Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",options=["Van het feit dat de onderliggende aanname klopt.","Van de lengte van het argument.","Van een informele stijl.","Van de ouderdom van de gegevens."],correct="Van het feit dat de onderliggende aanname klopt."),
...
AssessmentQuestion("nl-a1-010","vocabulary","A1","Wat betekent 'appel'?",["een vrucht","een voertuig","een gebouw","een meubel"],"een vrucht"),
AssessmentQuestion("nl-a1-011","reading","A1","Lees: 'Sara woont in Utrecht.' Waar woont Sara?",["In Utrecht.","In Rotterdam.","In Groningen.","In Eindhoven."],"In Utrecht."),
AssessmentQuestion("nl-a1-012","grammar","A1","Kies de juiste vorm.",["Hij heeft een auto.","Hij heeft een auto's.","Hij hebben een auto.","Hij heeft auto's."],"Hij heeft een auto."),
AssessmentQuestion("nl-a2-005","grammar","A2","Kies de juiste voltooide tijd.",["Ik heb gegeten.","Ik heb eten.","Ik heb at.","Ik eet heb."],"Ik heb gegeten."),
AssessmentQuestion("nl-a2-006","vocabulary","A2","Wat betekent 'vertraging'?",["iets dat later komt dan gepland","een reservering","een adres","een betaling"],"iets dat later komt dan gepland"),
AssessmentQuestion("nl-a2-007","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),
AssessmentQuestion("nl-a2-008","grammar","A2","Kies het juiste voorzetsel.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon aan Nederland."],"Ik woon in Nederland."),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste betrekkelijke bijzin.",["Dit is het boek dat ik heb gekocht.","Dit is het boek dat ik gekocht.","Dit is het boek die ik heb gekocht.","Dit is het boek ik dat heb gekocht."],"Dit is het boek dat ik heb gekocht."),
AssessmentQuestion("nl-b1-006","vocabulary","B1","Wat betekent 'uitdaging'?",["iets dat inspanning vereist","een beloning","een vakantie","een adres"],"iets dat inspanning vereist"),
...
AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste toegevende bijzin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen."),
...
AssessmentQuestion("nl-c1-006","vocabulary","C1","Wat betekent 'wezenlijk' in een academische context?",["belangrijk of significant","toevallig","tijdelijk","informeel"],"belangrijk of significant"),
AssessmentQuestion("nl-c1-007","reading","C1","Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat bewijst correlatie niet?",["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],"Dat het ene verschijnsel het andere veroorzaakt."),
AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werden in drie fasen uitgevoerd."],"Het onderzoek werd in drie fasen uitgevoerd."),
AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen."),
AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],"op meer dan één manier te interpreteren"),
AssessmentQuestion("nl-c2-007","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",["Of de onderliggende aanname klopt.","Of het argument kort is.","Of de tekst informeel is.","Of de gegevens oud zijn."],"Of de onderliggende aanname klopt."),
AssessmentQuestion("nl-c2-008","grammar","C2","Kies de meest precieze academische formulering.",["De resultaten laten geen eenduidige generalisatie toe zonder aanvullende gegevens.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren toe zonder aanvullende.","De resultaten laten een zekere generalisatie toe zonder analyse."],"De resultaten laten geen eenduidige generalisatie toe zonder aanvullende gegevens.")

AssessmentQuestion("nl-a1-009","grammar","A1","Kies de juiste vraag.",["Waar woon je?","Waar je woont?","Woon waar je?","Waar wonen?"],"Waar woon je?","vragen"),
AssessmentQuestion("nl-a1-010","vocabulary","A1","Wat betekent 'appel'?",["een fruit","een voertuig","een gebouw","een meubel"],"een fruit"),
AssessmentQuestion("nl-a1-011","reading","A1","Lees: 'Sara woont in Utrecht.' Waar woont Sara?",["In Utrecht.","In Rotterdam.","In Groningen.","In Eindhoven."],"In Utrecht."),
AssessmentQuestion("nl-a1-012","grammar","A1","Kies de juiste zin.",["Ik heb een boek.","Ik heb een boeken.","Ik hebben een boek.","Ik heb een boeken."],"Ik heb een boek.","lidwoorden"),
AssessmentQuestion("nl-a2-005","grammar","A2","Kies de juiste verleden tijd.",["Gisteren werkte ik thuis.","Gisteren werk ik thuis.","Gisteren werken ik thuis.","Gisteren gewerkt ik thuis."],"Gisteren werkte ik thuis.","verleden-tijd"),
AssessmentQuestion("nl-a2-006","vocabulary","A2","Wat betekent 'vertraging'?",["iets dat later komt dan gepland","een reservering","een adres","een betaling"],"iets dat later komt dan gepland"),
AssessmentQuestion("nl-a2-007","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),
AssessmentQuestion("nl-a2-008","grammar","A2","Kies het juiste voorzetsel.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik woon naar Nederland.","Ik woon aan Nederland."],"Ik woon in Nederland.","voorzetsels"),
AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste betrekkelijke bijzin.",["Dit is het boek dat ik kocht.","Dit is het boek dat ik gekocht.","Dit is het boek die ik kocht.","Dit is het boek dat kocht ik."],"Dit is het boek dat ik kocht.","betrekkelijke-bijzin"),
AssessmentQuestion("nl-b1-006","vocabulary","B1","Wat betekent 'uitdaging'?",["iets dat inspanning vraagt","een beloning","een vakantie","een adres"],"iets dat inspanning vraagt"),
AssessmentQuestion("nl-b1-007","reading","B1","Lees: 'De vergadering werd verplaatst omdat de directeur ziek was.' Waarom werd de vergadering verplaatst?",["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],"Omdat de directeur ziek was."),
AssessmentQuestion("nl-b1-008","grammar","B1","Kies de juiste woordvolgorde.",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],"Gisteren kocht ik een nieuwe computer.","woordvolgorde"),
AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste concessieve zin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen.","concessieve-zinnen"),
AssessmentQuestion("nl-b2-006","vocabulary","B2","Wat betekent 'voorspellen'?",["zeggen wat waarschijnlijk zal gebeuren","het verleden uitleggen","een regel veranderen","een afspraak annuleren"],"zeggen wat waarschijnlijk zal gebeuren"),
...
AssessmentQuestion("nl-c1-007","reading","C1","Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat bewijst correlatie niet?",["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],"Dat het ene verschijnsel het andere veroorzaakt."),
AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werd in drie fasen uitgevoerd."],"Het onderzoek werd in drie fasen uitgevoerd.","passief"),
AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen.","epistemische-modaliteit"),
AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],"op meer dan één manier te interpreteren"),
AssessmentQuestion("nl-c2-007","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname klopt.' Waarvan hangt de beoordeling af?",["Of de onderliggende aanname klopt.","Of het argument kort is.","Of de tekst informeel is.","Of de gegevens oud zijn."],"Of de onderliggende aanname klopt."),
AssessmentQuestion("nl-c2-008","grammar","C2","Kies de meest precieze academische formulering.",["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten geen generaliseren toe zonder aanvullende.","De resultaten laten een zekere generalisatie toe zonder analyse."],"De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","academische-stijl")
    ...
    AssessmentQuestion(id="nl-c1-007",skill="reading",difficulty="C1",question="Lees: 'Een correlatie bewijst op zichzelf geen oorzakelijk verband.' Wat wordt niet bewezen?",options=["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens bestaan.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],correct="Dat het ene verschijnsel het andere veroorzaakt."),
    ...
    AssessmentQuestion(id="nl-c2-005",skill="grammar",difficulty="C2",question="Welke formulering drukt epistemische voorzichtigheid uit?",options=["De invloed van andere factoren kan niet worden uitgesloten.","Andere factoren hebben zeker geen invloed.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],correct="De invloed van andere factoren kan niet worden uitgesloten."),
    AssessmentQuestion(id="nl-c2-006",skill="vocabulary",difficulty="C2",question="Wat betekent 'dubbelzinnig'?",options=["op meer dan één manier te interpreteren","volledig eenduidig","zeer kort","gemakkelijk te meten"],correct="op meer dan één manier te interpreteren"),
    ...
    AssessmentQuestion(id="nl-c2-008",skill="grammar",difficulty="C2",question="Welke academische formulering is het meest precies?",options=["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie toe zonder gegevens.","De resultaten laten zonder aanvullende gegevens geen generaliseren toe.","De resultaten laten een zekere generalisatie toe zonder analyse."],correct="De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.")
