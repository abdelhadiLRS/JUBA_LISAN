...
AssessmentQuestion("nl-c2-010","vocabulary","C2","Wat betekent 'voorbehoud' in een argumentatie?",["een beperking of kanttekening bij een bewering","een definitief bewijs","een herhaling van dezelfde zin","een informele begroeting"],"een beperking of kanttekening bij een bewering")
    ...
    AssessmentQuestion(id="nl-b1-009",skill="grammar",difficulty="B1",question="Welke zin gebruikt de voorwaardelijke wijs correct?",options=["Als ik tijd had, zou ik reizen.","Als ik tijd heb, zou ik gisteren reizen.","Als ik tijd had, reisde ik morgen.","Als ik tijd zou had, ik reis."],correct="Als ik tijd had, zou ik reizen."),
    AssessmentQuestion(id="nl-b1-010",skill="vocabulary",difficulty="B1",question="Wat betekent 'uitdaging'?",options=["iets dat inspanning vereist","een beloning","een vakantie","een adres"],correct="iets dat inspanning vereist"),
    AssessmentQuestion(id="nl-b1-011",skill="reading",difficulty="B1",question="Lees: 'De vergadering werd uitgesteld omdat de directeur ziek was.' Waarom werd de vergadering uitgesteld?",options=["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],correct="Omdat de directeur ziek was."),
