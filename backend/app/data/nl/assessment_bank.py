...
AssessmentQuestion("nl-a1-009","grammar","A1","Kies de juiste vraag.",["Waar woon je?","Waar je woont?","Waar wonen jij?","Waar woon?"],"Waar woon je?"),AssessmentQuestion("nl-a1-010","vocabulary","A1","Wat betekent 'appel'? ",["een vrucht","een voertuig","een gebouw","een meubel"],"een vrucht"),AssessmentQuestion("nl-a1-011","reading","A1","Lees: 'Sara woont in Utrecht.' Waar woont Sara?",["In Utrecht.","In Rotterdam.","In Groningen.","In Eindhoven."],"In Utrecht."),AssessmentQuestion("nl-a1-012","grammar","A1","Kies de juiste vorm.",["Hij heeft een auto.","Hij heeft een autos.","Hij hebben een auto.","Hij heb een auto."],"Hij heeft een auto."),AssessmentQuestion("nl-a2-005","grammar","A2","Kies de juiste verleden tijd.",["Gisteren werkte ik thuis.","Gisteren werk ik thuis.","Gisteren werken ik thuis.","Gisteren heb ik werk."],"Gisteren werkte ik thuis."),AssessmentQuestion("nl-a2-006","vocabulary","A2","Wat betekent 'vertraging'? ",["iets dat later gebeurt dan gepland","een reservering","een adres","een betaling"],"iets dat later gebeurt dan gepland"),AssessmentQuestion("nl-a2-007","reading","A2","Lees: 'De winkel sluit om zes uur.' Wanneer sluit de winkel?",["Om vijf uur.","Om zes uur.","Om zeven uur.","Om acht uur."],"Om zes uur."),AssessmentQuestion("nl-a2-008","grammar","A2","Kies de juiste zin.",["Ik woon in Nederland.","Ik woon op Nederland.","Ik wonen in Nederland.","Ik woont in Nederland."],"Ik woon in Nederland."),AssessmentQuestion("nl-b1-005","grammar","B1","Kies de juiste bijzin.",["Ik weet dat hij morgen komt.","Ik weet dat hij morgen komen.","Ik weet dat morgen hij komt.","Ik weet hij dat morgen komt."],"Ik weet dat hij morgen komt."),AssessmentQuestion("nl-b1-006","vocabulary","B1","Wat betekent 'uitdaging'?",["iets waarvoor inspanning nodig is","een beloning","een vakantie","een adres"],"iets waarvoor inspanning nodig is"),AssessmentQuestion("nl-b1-007","reading","B1","Lees: 'De vergadering werd verplaatst omdat de directeur ziek was.' Waarom werd de vergadering verplaatst?",["Omdat de directeur ziek was.","Omdat het kantoor gesloten was.","Omdat de trein vertraging had.","Omdat het een feestdag was."],"Omdat de directeur ziek was."),AssessmentQuestion("nl-b1-008","grammar","B1","Kies de juiste woordvolgorde.",["Gisteren kocht ik een nieuwe computer.","Gisteren ik kocht een nieuwe computer.","Gisteren kocht een nieuwe computer ik.","Gisteren een nieuwe computer kocht ik."],"Gisteren kocht ik een nieuwe computer."),AssessmentQuestion("nl-b2-005","grammar","B2","Kies de juiste concessieve zin.",["Hoewel het regende, gingen we wandelen.","Hoewel het regende, we gingen wandelen.","Hoewel regende het, gingen we wandelen.","Hoewel het regende, we wandelen gingen."],"Hoewel het regende, gingen we wandelen."),AssessmentQuestion("nl-b2-006","vocabulary","B2","Wat betekent 'voorspellen'?",["zeggen wat waarschijnlijk zal gebeuren","het verleden uitleggen","een regel veranderen","een afspraak annuleren"],"zeggen wat waarschijnlijk zal gebeuren"),AssessmentQuestion("nl-b2-007","reading","B2","Lees: 'De resultaten tonen een duidelijke tendens, maar moeten voorzichtig worden geïnterpreteerd.' Wat wordt aanbevolen?",["De resultaten voorzichtig interpreteren.","De resultaten negeren.","Alle resultaten veranderen.","Het onderzoek onmiddellijk stoppen."],"De resultaten voorzichtig interpreteren."),AssessmentQuestion("nl-b2-008","grammar","B2","Kies de juiste indirecte vraag.",["Ik weet niet wanneer de vergadering begint.","Ik weet niet wanneer begint de vergadering.","Ik weet niet wanneer de vergadering begint?","Ik weet niet de vergadering wanneer begint."],"Ik weet niet wanneer de vergadering begint."),AssessmentQuestion("nl-c1-005","grammar","C1","Kies de meest precieze academische formulering.",["De resultaten wijzen erop dat het effect beperkt is.","De resultaten wijzen erop het effect beperkt is.","De resultaten wijst erop dat het effect beperkt is.","De resultaten wijzen dat het effect erop beperkt is."],"De resultaten wijzen erop dat het effect beperkt is."),AssessmentQuestion("nl-c1-006","vocabulary","C1","Wat betekent 'wezenlijk' in een academische tekst?",["belangrijk of significant","toevallig","tijdelijk","informeel"],"belangrijk of significant"),AssessmentQuestion("nl-c1-007","reading","C1","Lees: 'Correlatie bewijst op zichzelf geen causaal verband.' Wat bewijst correlatie niet?",["Dat het ene verschijnsel het andere veroorzaakt.","Dat er gegevens zijn.","Dat variabelen samenhangen.","Dat er een analyse is uitgevoerd."],"Dat het ene verschijnsel het andere veroorzaakt."),AssessmentQuestion("nl-c1-008","grammar","C1","Kies de juiste passieve constructie.",["Het onderzoek werd in drie fasen uitgevoerd.","Het onderzoek werd in drie fasen uitvoeren.","Het onderzoek uitgevoerd werd in drie fasen.","Het onderzoek werden in drie fasen uitgevoerd."],"Het onderzoek werd in drie fasen uitgevoerd."),AssessmentQuestion("nl-c2-005","grammar","C2","Welke formulering drukt epistemische voorzichtigheid uit?",["Het kan niet worden uitgesloten dat andere factoren een rol spelen.","Andere factoren spelen zeker geen rol.","Het is zonder uitzondering bewezen dat andere factoren irrelevant zijn.","Andere factoren hoeven niet te worden onderzocht."],"Het kan niet worden uitgesloten dat andere factoren een rol spelen."),AssessmentQuestion("nl-c2-006","vocabulary","C2","Wat betekent 'dubbelzinnig'?",["vatbaar voor meer dan één interpretatie","volledig eenduidig","zeer kort","gemakkelijk meetbaar"],"vatbaar voor meer dan één interpretatie"),AssessmentQuestion("nl-c2-007","reading","C2","Lees: 'Het argument is overtuigend, mits de onderliggende aanname standhoudt.' Waarvan hangt de beoordeling af?",["Of de onderliggende aanname standhoudt.","Of de tekst kort is.","Of de stijl informeel is.","Of de gegevens oud zijn."],"Of de onderliggende aanname standhoudt."),AssessmentQuestion("nl-c2-008","grammar","C2","Kies de meest precieze academische formulering.",["De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.","De resultaten laten altijd generalisatie zonder gegevens toe.","De resultaten laten geen generaliseren met aanvullende gegevens toe.","De resultaten laten een eenduidige generalisatie toe zonder analyse."],"De resultaten laten zonder aanvullende gegevens geen eenduidige generalisatie toe.")
]
