"""Nederlands vocabulary — initial CEFR foundation."""
...
VOCABULARY_SETS=[
VocabularySet(id="greetings_a1",level="A1",topic="Greetings",unit_ref="a1-unit-1",words=[_w("hallo","phrase","basic greeting","hallo"),_w("dank je","phrase","thanks","dank je")]),
VocabularySet(id="identity_a1",level="A1",topic="Identity",unit_ref="a1-unit-1",words=[_w("naam","noun","name","naam"),_w("student","noun","student","student")]),
