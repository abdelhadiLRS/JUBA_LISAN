...
ASSESSMENT_BANK: list[AssessmentQuestion] = [
    ...
    # ── Additional balanced assessment questions ─────────────────────────────
    AssessmentQuestion(
        id="g-b2-010",
        skill="grammar",
        difficulty="B2",
    ...
    AssessmentQuestion(
        ...
        skill="grammar",
        difficulty="B2",
        question="If I ___ about the change earlier, I would have prepared differently.",
        options=["knew", "had known", "would know", "have known"],
        correct="had known",
        grammar_slug="third-conditional",
    ),
    AssessmentQuestion(
        id="g-b2-012",
        skill="grammar",
        difficulty="B2",
        question="The report needs ___ before it is published.",
        options=["to revise", "revising", "to be revised", "revised it"],
        correct="to be revised",
        grammar_slug="passive-infinitive",
    ),
    AssessmentQuestion(
        id="g-b2-013",
        skill="grammar",
        difficulty="B2",
        question="She denied ___ the confidential document.",
        options=["to copy", "copying", "to have copy", "copy"],
        correct="copying",
        grammar_slug="gerund-after-verbs",
    ),
    AssessmentQuestion(
        id="v-b2-007",
        skill="vocabulary",
        difficulty="B2",
        question="What does 'substantial' mean in this context: 'The company made substantial progress'?",
        options=["very limited", "considerable", "temporary", "uncertain"],
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="B2",
        question="Which verb best completes: 'The evidence ___ the conclusion that the system needs reform'?",
        options=["supports", "borrows", "occupies", "predicts"],
        correct="supports",
    ),
    AssessmentQuestion(
        id="r-b2-006",
        ...
        options=[
            ...
            "The project finished below budget.",
            "The review found no measurable benefits.",
        ],
        correct="The extra spending may be justified by future benefits.",
    ),
    AssessmentQuestion(
        id="g-c1-007",
        skill="grammar",
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="C1",
        question="Which word best describes an argument that is convincing and well supported?",
        options=["tenuous", "cogent", "arbitrary", "vague"],
        correct="cogent",
    ),
    AssessmentQuestion(
        id="r-c1-007",
        ...
        options=[
            ...
            "She accepts it cautiously while identifying important problems.",
            "She has not considered the proposal.",
        ],
        correct="She accepts it cautiously while identifying important problems.",
    ),
    AssessmentQuestion(
        id="r-c1-008",
        skill="reading",
        ...
        options=[
            ...
            "A larger headline figure.",
            "The removal of all historical data.",
        ],
    ...
    AssessmentQuestion(
        ...
        skill="grammar",
        difficulty="C2",
        question="It is essential that every applicant ___ the form in full.",
    ...
    AssessmentQuestion(
        ...
        skill="grammar",
        difficulty="C2",
        question="Only after the audit ___ the extent of the discrepancy become clear.",
        options=["did", "had", "was", "has"],
        correct="did",
        grammar_slug="only-after-inversion",
    ),
    AssessmentQuestion(
        id="v-c2-007",
        skill="vocabulary",
        ...
        options=["deliberate", "unintentional", "controversial", "irreversible"],
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="C2",
        question="Which word best describes a statement that is deliberately open to more than one interpretation?",
        options=["unequivocal", "ambiguous", "literal", "conclusive"],
        correct="ambiguous",
    ),
    AssessmentQuestion(
        id="v-c2-009",
        skill="vocabulary",
        difficulty="C2",
        question="What does 'provisional' mean in 'a provisional agreement'?",
        options=["final and irreversible", "temporary and subject to confirmation", "secret and unofficial", "legally impossible"],
        correct="temporary and subject to confirmation",
    ),
    AssessmentQuestion(
        id="r-c2-007",
        skill="reading",
        ...
        options=[
            ...
            "To avoid providing any evidence.",
            "To contradict the entire passage.",
        ],
        correct="To make the argument appear more credible.",
    ),
    AssessmentQuestion(
        id="r-c2-008",
        skill="reading",
        ...
        options=[
            ...
            "It rejects the original evidence.",
            "It changes the subject completely.",
        ],
        correct="It distinguishes between different time horizons.",
    ),
    AssessmentQuestion(
        id="r-c2-009",
        skill="reading",
        ...
        options=[
            ...
            "Economic growth versus population decline.",
            "Legal rules versus historical evidence.",
        ],
