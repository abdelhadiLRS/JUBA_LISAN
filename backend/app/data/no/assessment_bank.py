...
AssessmentQuestion("no-c1-007","reading","C1","Les: «Korrelasjon beviser ikke i seg selv et årsakssammenheng.» Hva beviser korrelasjonen ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At det er gjort en analyse."],"At det ene fenomenet forårsaker det andre."),
