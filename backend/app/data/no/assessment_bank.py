...
AssessmentQuestion("no-a1-008","grammar","A1","Velg riktig form.",["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],"Hun har en bil.","en-et"),
AssessmentQuestion("no-a2-005","grammar","A2","Velg riktig preteritum.",["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går jobbet hjemme jeg."],"I går jobbet jeg hjemme.","preteritum"),
AssessmentQuestion("no-a2-006","vocabulary","A2","Hva betyr «forsinkelse»?",["noe som kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],"noe som kommer senere enn planlagt"),
AssessmentQuestion("no-a2-007","reading","A2","Les: «Butikken stenger klokken seks.» Når stenger butikken?",["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],"Klokken seks."),
AssessmentQuestion("no-a2-008","grammar","A2","Velg riktig modalverb.",["Jeg må jobbe i morgen.","Jeg må jobber i morgen.","Jeg må jobbet i morgen.","Jeg må jobberte i morgen."],"Jeg må jobbe i morgen.","modalverb"),
AssessmentQuestion("no-b1-005","grammar","B1","Velg riktig relativsetning.",["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken jeg som kjøpte.","Dette er boken som kjøpte jeg."],"Dette er boken som jeg kjøpte.","relativsetninger"),
AssessmentQuestion("no-b1-006","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
AssessmentQuestion("no-b1-007","reading","B1","Les: «Møtet ble utsatt fordi direktøren var syk.» Hvorfor ble møtet utsatt?",["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var en helligdag."],"Fordi direktøren var syk."),
AssessmentQuestion("no-b1-008","grammar","B1","Velg riktig ordstilling.",["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],"I går kjøpte jeg en ny datamaskin.","ordstilling"),
AssessmentQuestion("no-b2-005","grammar","B2","Velg riktig leddsetning med innrømmelse.",["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],"Selv om det regnet, gikk vi en tur.","innrømmelse"),
AssessmentQuestion("no-b2-006","vocabulary","B2","Hva betyr «forutsi»?",["å si hva man tror vil skje","å forklare fortiden","å endre en regel","å avlyse en avtale"],"å si hva man tror vil skje"),
AssessmentQuestion("no-b2-007","reading","B2","Les: «Resultatene viser en tydelig tendens, men de bør tolkes med forsiktighet.» Hva anbefales?",["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen."],"Forsiktig tolkning av resultatene."),
AssessmentQuestion("no-b2-008","grammar","B2","Velg riktig indirekte spørsmål.",["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],"Jeg vet ikke når møtet begynner.","indirekte-spørsmål"),
AssessmentQuestion("no-c1-005","grammar","C1","Velg den mest presise akademiske formuleringen.",["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset er."],"Resultatene tyder på at effekten er begrenset.","akademisk-språk"),
AssessmentQuestion("no-c1-006","vocabulary","C1","Hva betyr «vesentlig» i akademisk sammenheng?",["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],"betydningsfull eller viktig"),
AssessmentQuestion("no-c1-007","reading","C1","Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva bevises ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-008","grammar","C1","Velg riktig passiv konstruksjon.",["Studien ble gjennomført i tre trinn.","Studien ble gjennomføre i tre trinn.","Studien gjennomført ble i tre trinn.","Studien ble gjennomfører i tre trinn."],"Studien ble gjennomført i tre trinn.","passiv"),
AssessmentQuestion("no-c2-005","grammar","C2","Hvilken formulering uttrykker akademisk forsiktighet?",["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ingen grunn til å undersøke andre faktorer."],"Det kan ikke utelukkes at andre faktorer spiller en rolle.","epistemisk-modalisering"),
AssessmentQuestion("no-c2-006","vocabulary","C2","Hva betyr «tvetydig»?",["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på mer enn én måte"),
AssessmentQuestion("no-c2-007","reading","C2","Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",["At den underliggende antakelsen holder.","At teksten er kort.","At stilen er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion("no-c2-008","grammar","C2","Velg den mest presise akademiske formuleringen.",["Resultatene tillater ikke en entydig generalisering uten ytterligere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisere ytterligere data.","Resultatene tillater en sikker generalisering uten analyse."],"Resultatene tillater ikke en entydig generalisering uten ytterligere data.","akademisk-stil")

AssessmentQuestion(id="no-a1-009",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil."),
AssessmentQuestion(id="no-a1-010",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-011",skill="reading",difficulty="A1",question="«Kari bor i Bergen.» Hvor bor Kari?",options=["Oslo","Bergen","Trondheim","Stavanger"],correct="Bergen"),
AssessmentQuestion(id="no-a1-012",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Hvor bor?","Hvor du bor er?"],correct="Hvor bor du?"),
AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig framtidsuttrykk.",options=["Jeg skal reise i morgen.","Jeg skal reiste i morgen.","Jeg skal reiser i morgen.","Jeg skal å reise i morgen."],correct="Jeg skal reise i morgen."),
AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «avtale»?",options=["et planlagt møte eller en overenskomst","en sykdom","en bygning","en reise"],correct="et planlagt møte eller en overenskomst"),
...
AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007",skill="reading",difficulty="B1",question="«Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var en helligdag."],correct="Fordi direktøren var syk."),
...
AssessmentQuestion(id="no-c1-006",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i akademisk språk?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
...
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passivkonstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomført tre faser."],correct="Studien ble gjennomført i tre faser."),
...
AssessmentQuestion(id="no-c2-008",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Funnene tillater ingen entydig konklusjon uten ytterligere data.","Funnene tillater alltid en konklusjon uten data.","Funnene tillater ikke konkludere uten ytterligere.","Funnene tillater en sikker konklusjon uten analyse."],correct="Funnene tillater ingen entydig konklusjon uten ytterligere data.")

AssessmentQuestion("no-a1-005","grammar","A1","Velg riktig spørsmål.",["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],"Hvor bor du?"),
AssessmentQuestion("no-a1-006","vocabulary","A1","Hva betyr «eple»?",["en frukt","et kjøretøy","en bygning","et møbel"],"en frukt"),
AssessmentQuestion("no-a1-007","reading","A1","Les: «Sara bor i Bergen.» Hvor bor Sara?",["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],"I Bergen."),
AssessmentQuestion("no-a1-008","grammar","A1","Velg riktig form.",["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],"Hun har en bil."),
AssessmentQuestion("no-a2-005","grammar","A2","Velg riktig perfektum.",["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spiser har."],"Jeg har spist."),
AssessmentQuestion("no-a2-006","vocabulary","A2","Hva betyr «forsinkelse»?",["at noe kommer senere enn planlagt","en bestilling","en adresse","en betaling"],"at noe kommer senere enn planlagt"),
AssessmentQuestion("no-a2-007","reading","A2","Les: «Butikken stenger klokken seks.» Når stenger butikken?",["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],"Klokken seks."),
AssessmentQuestion("no-a2-008","grammar","A2","Velg riktig preposisjon.",["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor til Norge.","Jeg bor ved Norge."],"Jeg bor i Norge."),
AssessmentQuestion("no-b1-005","grammar","B1","Velg riktig relativsetning.",["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken jeg som kjøpte."],"Dette er boken som jeg kjøpte."),
AssessmentQuestion("no-b1-006","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
...
AssessmentQuestion("no-b1-008","grammar","B1","Velg riktig ordstilling.",["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],"I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion("no-b2-005","grammar","B2","Velg riktig innrømmende leddsetning.",["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],"Selv om det regnet, gikk vi en tur."),
AssessmentQuestion("no-b2-006","vocabulary","B2","Hva betyr «forutsi»?",["å anslå hva som sannsynligvis vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],"å anslå hva som sannsynligvis vil skje"),
AssessmentQuestion("no-b2-007","reading","B2","Les: «Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen."],"Forsiktig tolkning av resultatene."),
AssessmentQuestion("no-b2-008","grammar","B2","Velg riktig indirekte spørsmål.",["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],"Jeg vet ikke når møtet begynner."),
AssessmentQuestion("no-c1-005","grammar","C1","Velg den mest presise akademiske formuleringen.",["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],"Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion("no-c1-006","vocabulary","C1","Hva betyr «vesentlig» i akademisk sammenheng?",["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],"betydningsfull eller viktig"),
AssessmentQuestion("no-c1-007","reading","C1","Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser korrelasjonen ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-008","grammar","C1","Velg riktig passiv konstruksjon.",["Studien ble gjennomført i tre trinn.","Studien ble gjennomføre i tre trinn.","Studien gjennomført ble i tre trinn.","Studien ble gjennomførte i tre trinn."],"Studien ble gjennomført i tre trinn."),
AssessmentQuestion("no-c2-005","grammar","C2","Hvilken formulering uttrykker akademisk forsiktighet?",["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ikke nødvendig å undersøke andre faktorer."],"Det kan ikke utelukkes at andre faktorer spiller en rolle."),
AssessmentQuestion("no-c2-006","vocabulary","C2","Hva betyr «tvetydig»?",["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på mer enn én måte"),
AssessmentQuestion("no-c2-007","reading","C2","Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion("no-c2-008","grammar","C2","Velg den mest presise akademiske formuleringen.",["Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.","Resultatene gir alltid grunnlag for generalisering uten data.","Resultatene gir ikke grunnlag for å generalisere uten flere.","Resultatene gir grunnlag for en sikker generalisering uten analyse."],"Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.")

AssessmentQuestion("no-a1-005","grammar","A1","Velg riktig spørsmål.",["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bo?"],"Hvor bor du?","spørsmål"),
AssessmentQuestion("no-a1-006","vocabulary","A1","Hva betyr «eple»?",["en frukt","et kjøretøy","en bygning","et møbel"],"en frukt"),
AssessmentQuestion("no-a1-007","reading","A1","Les: «Sara bor i Bergen.» Hvor bor Sara?",["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],"I Bergen."),
AssessmentQuestion("no-a1-008","grammar","A1","Velg riktig setning.",["Jeg har en bok.","Jeg har et bok.","Jeg har en bøker.","Jeg ha en bok."],"Jeg har en bok.","substantiv"),
AssessmentQuestion("no-a2-005","grammar","A2","Velg riktig fortidsform.",["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går jobbet hjemme jeg."],"I går jobbet jeg hjemme.","preteritum"),
AssessmentQuestion("no-a2-006","vocabulary","A2","Hva betyr «forsinkelse»?",["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],"at noe kommer senere enn planlagt"),
AssessmentQuestion("no-a2-007","reading","A2","Les: «Butikken stenger klokken seks.» Når stenger butikken?",["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],"Klokken seks."),
...
AssessmentQuestion("no-b1-005","grammar","B1","Velg riktig relativsetning.",["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken som jeg kjøpte den."],"Dette er boken som jeg kjøpte.","relativsetninger"),
AssessmentQuestion("no-b1-006","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
AssessmentQuestion("no-b1-007","reading","B1","Les: «Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var en helligdag."],"Fordi direktøren var syk."),
AssessmentQuestion("no-b1-008","grammar","B1","Velg riktig ordstilling.",["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],"I går kjøpte jeg en ny datamaskin.","ordstilling"),
...
AssessmentQuestion("no-b2-006","vocabulary","B2","Hva betyr «forutsi»?",["å si hva som sannsynligvis vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],"å si hva som sannsynligvis vil skje"),
...
AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="Les: «Maria bor i Bergen.» Hvor bor Maria?",options=["Bergen","Oslo","Trondheim","Stavanger"],correct="Bergen"),
...
AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig perfektum.",options=["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spise har."],correct="Jeg har spist."),
AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007",skill="reading",difficulty="A2",question="Les: «Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
AssessmentQuestion(id="no-a2-008",skill="grammar",difficulty="A2",question="Velg riktig preposisjon.",options=["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor til Norge.","Jeg bor ved Norge."],correct="Jeg bor i Norge."),
...
AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «erfaring»?",options=["kunnskap fra tidligere opplevelser","en billett","en bygning","en avtale"],correct="kunnskap fra tidligere opplevelser"),
AssessmentQuestion(id="no-b1-007",skill="reading",difficulty="B1",question="Les: «Møtet ble utsatt fordi lederen var syk.» Hvorfor ble møtet utsatt?",options=["Fordi lederen var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var ferie."],correct="Fordi lederen var syk."),
AssessmentQuestion(id="no-b1-008",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion(id="no-b2-005",skill="grammar",difficulty="B2",question="Velg riktig innrømmende konstruksjon.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur."),
AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «påvirke»?",options=["å ha innflytelse på noe","å reise","å betale","å presentere seg"],correct="å ha innflytelse på noe"),
AssessmentQuestion(id="no-b2-007",skill="reading",difficulty="B2",question="Les: «Undersøkelsen viser en tydelig tendens, men resultatene bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere undersøkelsen.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],correct="Forsiktig tolkning av resultatene."),
AssessmentQuestion(id="no-b2-008",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner."),
...
AssessmentQuestion(id="no-c1-006",skill="vocabulary",difficulty="C1",question="Hva betyr «forutsetning» i en akademisk tekst?",options=["en betingelse som må være oppfylt","en avslutning","en følelse","en nyhet"],correct="en betingelse som må være oppfylt"),
AssessmentQuestion(id="no-c1-007",skill="reading",difficulty="C1",question="Les: «Korrelasjonen viser et mønster, men beviser ikke årsakssammenheng.» Hva kan vi ikke konkludere med?",options=["At det ene fenomenet forårsaker det andre.","At det finnes et mønster.","At dataene kan analyseres.","At variablene henger sammen."],correct="At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre trinn.","Studien ble gjennomføre i tre trinn.","Studien gjennomført ble i tre trinn.","Studien ble gjennomført tre trinn."],correct="Studien ble gjennomført i tre trinn."),
...
AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="«Sara bor i Bergen.» Hvor bor Sara?",options=["Bergen","Oslo","Stavanger","Tromsø"],correct="Bergen"),
AssessmentQuestion(id="no-a1-008",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil."),
AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig perfektum.",options=["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spise har."],correct="Jeg har spist."),
AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007",skill="reading",difficulty="A2",question="«Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
...
AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva man tror vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],correct="å si hva man tror vil skje"),
...
AssessmentQuestion("no-c1-028","grammar","C1","Velg den mest presise formuleringen.",["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder at effekten på er begrenset."],"Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion("no-c1-029","vocabulary","C1","Hva betyr «vesentlig» i en faglig tekst?",["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],"betydningsfull eller viktig"),
AssessmentQuestion("no-c1-030","reading","C1","Les: «Korrelasjonen viser en sammenheng, men beviser ikke i seg selv årsakssammenheng.» Hva kan ikke fastslås?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At analysen er gjennomført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-031","grammar","C1","Velg korrekt passiv konstruksjon.",["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomført tre faser."],"Studien ble gjennomført i tre faser."),
AssessmentQuestion("no-c1-032","vocabulary","C1","Hva betyr «forutsetning»?",["en betingelse som må være oppfylt","en avslutning","en følelse","en nyhet"],"en betingelse som må være oppfylt"),
AssessmentQuestion("no-c1-033","reading","C1","Les: «Selv om dataene peker i samme retning, kan studien ikke etablere en sikker årsakssammenheng.» Hva er begrensningen?",["Studien kan ikke fastslå årsakssammenheng med sikkerhet.","Studien mangler alle data.","Resultatene peker i motsatt retning.","Studien ble ikke gjennomført."],"Studien kan ikke fastslå årsakssammenheng med sikkerhet."),
AssessmentQuestion("no-c1-034","grammar","C1","Velg korrekt indirekte spørsmål.",["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],"Jeg vet ikke når møtet begynner."),
AssessmentQuestion("no-c1-035","grammar","C1","Hvilken formulering passer best i et formelt argument?",["Dette kan tyde på at effekten er mindre enn tidligere antatt.","Dette tyder helt sikkert på alt.","Dette kan tyde at effekten mindre enn antatt.","Dette tyde på at effekten er mindre."],"Dette kan tyde på at effekten er mindre enn tidligere antatt."),
AssessmentQuestion("no-c2-025","grammar","C2","Hvilken formulering uttrykker best epistemisk forsiktighet?",["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller helt sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er unødvendig å undersøke andre faktorer."],"Det kan ikke utelukkes at andre faktorer spiller en rolle."),
AssessmentQuestion("no-c2-026","vocabulary","C2","Hva betyr «tvetydig»?",["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på mer enn én måte"),
AssessmentQuestion("no-c2-027","reading","C2","Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion("no-c2-028","grammar","C2","Velg den mest idiomatiske akademiske formuleringen.",["Til tross for begrensningene bør resultatene ikke avvises uten videre.","Til tross begrensningene bør resultatene ikke avvises.","Til tross for begrensningene resultatene bør ikke avvises.","Til tross av begrensningene bør resultatene ikke avvises."],"Til tross for begrensningene bør resultatene ikke avvises uten videre."),
AssessmentQuestion("no-c2-029","vocabulary","C2","Hva betyr «nyansert»?",["som tar hensyn til fine forskjeller og flere sider","som bare har én betydning","som er svært kort","som er helt tilfeldig"],"som tar hensyn til fine forskjeller og flere sider"),
AssessmentQuestion("no-c2-030","reading","C2","Les: «Funnene er lovende, men kan ikke generaliseres uten et bredere datagrunnlag.» Hva kreves?",["Et bredere datagrunnlag for å kunne generalisere.","At funnene forkastes.","At analysen avsluttes.","At alle variabler fjernes."],"Et bredere datagrunnlag for å kunne generalisere."),
AssessmentQuestion("no-c2-031","grammar","C2","Velg korrekt formulering med forbehold.",["Selv om resultatene er interessante, bør de tolkes med varsomhet.","Selv om resultatene er interessante, de bør tolkes med varsomhet.","Selv om resultatene interessante, bør tolkes de med varsomhet.","Selv resultatene er interessante, bør de tolkes med varsomhet."],"Selv om resultatene er interessante, bør de tolkes med varsomhet."),
AssessmentQuestion("no-c2-032","grammar","C2","Hvilken formulering skiller best mellom korrelasjon og årsak?",["En statistisk sammenheng er ikke nødvendigvis et bevis på årsak.","En statistisk sammenheng beviser alltid årsak.","En korrelasjon har alltid én bestemt årsak.","En årsak kan aldri ha statistisk sammenheng."],"En statistisk sammenheng er ikke nødvendigvis et bevis på årsak.")
]
