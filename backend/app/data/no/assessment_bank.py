...
AssessmentQuestion(id="no-c1-008-dup2",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomførte i tre faser."],correct="Studien ble gjennomført i tre faser.",grammar_slug="passiv"),
AssessmentQuestion(id="no-c1-009-dup2",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig»?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-010-dup2",skill="reading",difficulty="C1",question="Les: «Korrelasjon alene viser ikke at det ene forholdet forårsaker det andre.» Hva kan ikke fastslås?",options=["En årsakssammenheng.","At dataene finnes.","At variablene henger sammen.","At analysen er gjennomført."],correct="En årsakssammenheng."),
AssessmentQuestion(id="no-c1-011-dup2",skill="grammar",difficulty="C1",question="Velg den mest presise formuleringen.",options=["Resultatene antyder at effekten er begrenset.","Resultatene antyder effekten at er begrenset.","Resultatene antyder at effekten begrenset.","Resultatene antyder, effekten er begrenset."],correct="Resultatene antyder at effekten er begrenset.",grammar_slug="akademisk-språk"),
AssessmentQuestion(id="no-c1-012-dup2",skill="reading",difficulty="C1",question="Les: «Datagrunnlaget er begrenset, og funnene bør derfor tolkes med varsomhet.» Hva anbefales?",options=["Forsiktig tolkning av funnene.","Å forkaste alle funn.","Å ignorere datagrunnlaget.","Å trekke en helt sikker konklusjon."],correct="Forsiktig tolkning av funnene."),
AssessmentQuestion(id="no-c2-005-dup2",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker epistemisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller inn.","Andre faktorer spiller definitivt ingen rolle.","Det er bevist at ingen andre faktorer finnes.","Andre faktorer trenger ikke undersøkes."],correct="Det kan ikke utelukkes at andre faktorer spiller inn.",grammar_slug="epistemisk-modalisering"),
AssessmentQuestion(id="no-c2-006-dup2",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],correct="som kan forstås på mer enn én måte"),
AssessmentQuestion(id="no-c2-007-dup2",skill="reading",difficulty="C2",question="Les: «Argumentet er overbevisende, forutsatt at den grunnleggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den grunnleggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],correct="At den grunnleggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008-dup2",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Funnene gir ikke grunnlag for en entydig konklusjon uten flere data.","Funnene gir alltid grunnlag for en sikker konklusjon.","Funnene gir ikke grunnlag konkludere uten data.","Funnene gir grunnlag for en entydig konklusjon uten analyse."],correct="Funnene gir ikke grunnlag for en entydig konklusjon uten flere data.",grammar_slug="akademisk-formulering")

AssessmentQuestion(id="no-a1-005-dup2",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bo?"],"Hvor bor du?"),
AssessmentQuestion(id="no-a1-006-dup2",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007-dup2",skill="reading",difficulty="A1",question="«Kari bor i Bergen.» Hvor bor Kari?",options=["Oslo","Bergen","Trondheim","Stavanger"],correct="Bergen"),
AssessmentQuestion(id="no-a1-008-dup2",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil."),
AssessmentQuestion(id="no-a2-005-dup2",skill="grammar",difficulty="A2",question="Velg riktig preteritum.",options=["I går kjøpte jeg en bok.","I går kjøper jeg en bok.","I går kjøpe jeg en bok.","I går skal jeg kjøpe en bok."],correct="I går kjøpte jeg en bok."),
AssessmentQuestion(id="no-a2-006-dup2",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007-dup2",skill="reading",difficulty="A2",question="«Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
AssessmentQuestion(id="no-a2-008-dup2",skill="grammar",difficulty="A2",question="Velg riktig modalverb.",options=["Jeg må arbeide.","Jeg må arbeider.","Jeg må arbeidet.","Jeg må å arbeide."],correct="Jeg må arbeide."),
AssessmentQuestion(id="no-b1-005-dup2",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken som jeg kjøpte den."],correct="Dette er boken som jeg kjøpte."),
AssessmentQuestion(id="no-b1-006-dup2",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007-dup2",skill="reading",difficulty="B1",question="«Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi lokalet var stengt.","Fordi toget var forsinket.","Fordi det var ferie."],correct="Fordi direktøren var syk."),
AssessmentQuestion(id="no-b1-008-dup2",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion(id="no-c1-005-dup2",skill="grammar",difficulty="C1",question="Velg den mest presise formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],correct="Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion(id="no-c1-006-dup2",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en akademisk tekst?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007-dup2",skill="reading",difficulty="C1",question="«Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva bevises ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At analysen er gjennomført."],correct="At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008-dup3",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre trinn.","Studien ble gjennomføre i tre trinn.","Studien gjennomført ble i tre trinn.","Studien ble gjennomfører i tre trinn."],correct="Studien ble gjennomført i tre trinn."),
AssessmentQuestion(id="no-c2-005-dup3",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ikke nødvendig å undersøke andre faktorer."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle."),
AssessmentQuestion(id="no-c2-006-dup3",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],correct="som kan forstås på mer enn én måte"),
AssessmentQuestion(id="no-c2-007-dup3",skill="reading",difficulty="C2",question="«Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],correct="At den underliggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008-dup3",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tillater ikke en entydig generalisering uten flere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisere uten flere.","Resultatene tillater en sikker generalisering uten analyse."],correct="Resultatene tillater ikke en entydig generalisering uten flere data.")

AssessmentQuestion(id="no-a1-009-dup2",skill="grammar",difficulty="A1",question="Velg riktig setning.",options=["Jeg heter Anna.","Jeg heter Anna er.","Jeg hete Anna.","Jeg heter Annaen."],correct="Jeg heter Anna."),
AssessmentQuestion(id="no-a1-010-dup2",skill="vocabulary",difficulty="A1",question="Hva betyr «bok»?",options=["en tekst du kan lese","en drikk","et kjøretøy","et yrke"],correct="en tekst du kan lese"),
AssessmentQuestion(id="no-a1-011-dup2",skill="reading",difficulty="A1",question="«Per spiser frokost hjemme.» Hvor spiser Per frokost?",options=["Hjemme","På skolen","På jobben","På hotellet"],correct="Hjemme"),
AssessmentQuestion(id="no-a1-012-dup2",skill="grammar",difficulty="A1",question="Velg riktig artikkel.",options=["en bil","et bil","ei bilene","en bilen"],correct="en bil"),
...
AssessmentQuestion(id="no-a2-009-dup2",skill="grammar",difficulty="A2",question="Velg riktig futurum.",options=["Jeg skal reise i morgen.","Jeg skal reiser i morgen.","Jeg reiste i morgen.","Jeg skal reist i morgen."],correct="Jeg skal reise i morgen."),
AssessmentQuestion(id="no-a2-010-dup2",skill="vocabulary",difficulty="A2",question="Hva betyr «avtale»?",options=["et planlagt møte eller arrangement","en forsinkelse","en bygning","en reise"],correct="et planlagt møte eller arrangement"),
AssessmentQuestion(id="no-a2-011-dup2",skill="reading",difficulty="A2",question="«Maria jobber på et sykehus.» Hvor jobber Maria?",options=["På et sykehus","På en stasjon","I en butikk","På et bibliotek"],correct="På et sykehus"),
AssessmentQuestion(id="no-a2-012-dup2",skill="grammar",difficulty="A2",question="Velg riktig komparativ.",options=["Denne bilen er billigere.","Denne bilen er billigestere.","Denne bilen er mer billigere.","Denne bilen billigere er."],correct="Denne bilen er billigere."),
...
AssessmentQuestion(id="no-b1-009-dup2",skill="grammar",difficulty="B1",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når toget kommer.","Jeg vet ikke når kommer toget.","Jeg vet ikke toget når kommer.","Jeg vet ikke når toget kommer?"],"Jeg vet ikke når toget kommer."),
AssessmentQuestion(id="no-b1-010-dup2",skill="vocabulary",difficulty="B1",question="Hva betyr «erfaring»?",options=["kunnskap fra tidligere opplevelser","en billett","en bygning","en avtale"],correct="kunnskap fra tidligere opplevelser"),
AssessmentQuestion(id="no-b1-011-dup2",skill="reading",difficulty="B1",question="«Resultatene viser forbedring, men mer forskning er nødvendig.» Hva er nødvendig?",options=["Mer forskning","Mindre data","En ny avtale","En annen metode"],correct="Mer forskning"),
AssessmentQuestion(id="no-b1-012-dup2",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny bok.","I går jeg kjøpte en ny bok.","I går kjøpte en ny bok jeg.","I går en ny bok kjøpte jeg."],correct="I går kjøpte jeg en ny bok."),
...
AssessmentQuestion(id="no-b2-009-dup2",skill="grammar",difficulty="B2",question="Velg riktig betingelsessetning.",options=["Hvis jeg hadde tid, ville jeg reist.","Hvis jeg hadde tid, vil jeg reist.","Hvis jeg har tid, ville jeg reist i går.","Hvis jeg hadde tid, jeg ville reise."],correct="Hvis jeg hadde tid, ville jeg reist."),
AssessmentQuestion(id="no-b2-010-dup2",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsetning»?",options=["en betingelse som må være oppfylt","en avslutning","en følelse","en nyhet"],correct="en betingelse som må være oppfylt"),
AssessmentQuestion(id="no-b2-011-dup2",skill="reading",difficulty="B2",question="«Undersøkelsen peker mot en tydelig tendens, men funnene må tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning","Å ignorere funnene","Å endre alle data","Å avslutte studien"],correct="Forsiktig tolkning"),
AssessmentQuestion(id="no-b2-012-dup2",skill="grammar",difficulty="B2",question="Velg riktig passivkonstruksjon.",options=["Rapporten ble publisert i går.","Rapporten ble publisere i går.","Rapporten publiserte i går.","Rapporten ble publiserer i går."],correct="Rapporten ble publisert i går."),
...
AssessmentQuestion(id="no-c2-009-dup2",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker epistemisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller inn.","Andre faktorer spiller definitivt ingen rolle.","Det er bevist uten unntak at alle andre forklaringer er feil.","Andre faktorer trenger ikke å undersøkes."],"Det kan ikke utelukkes at andre faktorer spiller inn."),
AssessmentQuestion(id="no-c2-010-dup2",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på flere måter","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på flere måter"),
AssessmentQuestion(id="no-c2-011-dup2",skill="reading",difficulty="C2",question="«Argumentet er overbevisende, forutsatt at den grunnleggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den grunnleggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],"At den grunnleggende antakelsen holder."),
AssessmentQuestion(id="no-c2-012-dup2",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.","Resultatene gir alltid grunnlag for generalisering uten data.","Resultatene gir ikke grunnlag generalisere uten flere.","Resultatene gir grunnlag for sikker generalisering uten analyse."],"Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.")

AssessmentQuestion(id="no-a1-005-dup3",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bo du?"],correct="Hvor bor du?"),
AssessmentQuestion(id="no-a1-006-dup3",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007-dup3",skill="reading",difficulty="A1",question="«Maria bor i Bergen.» Hvor bor Maria?",options=["Bergen","Oslo","Trondheim","Stavanger"],correct="Bergen"),
AssessmentQuestion(id="no-a1-008-dup3",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil."),
AssessmentQuestion(id="no-a2-005-dup3",skill="grammar",difficulty="A2",question="Velg riktig preteritum.",options=["I går kjøpte jeg en bok.","I går kjøper jeg en bok.","I går kjøpe jeg en bok.","I går har kjøpte jeg en bok."],correct="I går kjøpte jeg en bok."),
AssessmentQuestion(id="no-a2-006-dup3",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007-dup3",skill="reading",difficulty="A2",question="«Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
AssessmentQuestion(id="no-a2-008-dup3",skill="grammar",difficulty="A2",question="Velg riktig modalverb.",options=["Jeg må jobbe i morgen.","Jeg må jobber i morgen.","Jeg må jobbet i morgen.","Jeg må arbeid i morgen."],correct="Jeg må jobbe i morgen."),
AssessmentQuestion(id="no-b1-005-dup3",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boka som jeg kjøpte.","Dette er boka som jeg kjøpt.","Dette er boka som kjøpte jeg.","Dette er boka som jeg kjøpte den."],correct="Dette er boka som jeg kjøpte."),
AssessmentQuestion(id="no-b1-006-dup3",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007-dup3",skill="reading",difficulty="B1",question="«Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var helligdag."],correct="Fordi direktøren var syk."),
AssessmentQuestion(id="no-b1-008-dup3",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion(id="no-b2-005-dup2",skill="grammar",difficulty="B2",question="Velg riktig leddsetning som uttrykker kontrast.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om det regnet, gikk vi en turen.","Selv om regnet det, gikk vi en tur."],correct="Selv om det regnet, gikk vi en tur."),
AssessmentQuestion(id="no-b2-006-dup2",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva som sannsynligvis vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],correct="å si hva som sannsynligvis vil skje"),
AssessmentQuestion(id="no-b2-007-dup2",skill="reading",difficulty="B2",question="«Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],correct="Forsiktig tolkning av resultatene."),
AssessmentQuestion(id="no-b2-008-dup2",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner."),
AssessmentQuestion(id="no-c1-005-dup3",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],correct="Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion(id="no-c1-006-dup3",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en akademisk tekst?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007-dup3",skill="reading",difficulty="C1",question="«Korrelasjon alene beviser ikke en årsakssammenheng.» Hva beviser korrelasjonen ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At det er gjort en analyse."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008-dup4",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomført tre faser."],correct="Studien ble gjennomført i tre faser."),
AssessmentQuestion(id="no-c2-005-dup4",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ikke nødvendig å undersøke andre faktorer."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle."),
AssessmentQuestion(id="no-c2-006-dup4",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],correct="som kan forstås på mer enn én måte"),
AssessmentQuestion(id="no-c2-007-dup4",skill="reading",difficulty="C2",question="«Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],correct="At den underliggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008-dup4",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tillater ikke en entydig generalisering uten flere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisering uten flere.","Resultatene tillater en sikker generalisering uten analyse."],correct="Resultatene tillater ikke en entydig generalisering uten flere data.")

AssessmentQuestion(id="no-a1-005-dup4",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],correct="Hvor bor du?",grammar_slug="spørsmål"),
AssessmentQuestion(id="no-a1-006-dup4",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007-dup4",skill="reading",difficulty="A1",question="Les: «Erik bor i Bergen.» Hvor bor Erik?",options=["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],correct="I Bergen."),
AssessmentQuestion(id="no-a1-008-dup4",skill="grammar",difficulty="A1",question="Velg riktig setning.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil.",grammar_slug="substantiv"),
AssessmentQuestion(id="no-a2-005-dup4",skill="grammar",difficulty="A2",question="Velg riktig perfektum.",options=["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spiser har."],correct="Jeg har spist.",grammar_slug="perfektum"),
AssessmentQuestion(id="no-a2-006-dup4",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["noe som kommer senere enn planlagt","en bestilling","en adresse","en betaling"],correct="noe som kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007-dup4",skill="reading",difficulty="A2",question="Les: «Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
AssessmentQuestion(id="no-a2-008-dup4",skill="grammar",difficulty="A2",question="Velg riktig preposisjon.",options=["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor til Norge.","Jeg bor ved Norge."],correct="Jeg bor i Norge.",grammar_slug="preposisjoner"),
AssessmentQuestion(id="no-b1-005-dup4",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boka som jeg kjøpte.","Dette er boka som jeg kjøpt.","Dette er boka jeg som kjøpte.","Dette er boka som kjøpte jeg."],correct="Dette er boka som jeg kjøpte.",grammar_slug="relativsetninger"),
AssessmentQuestion(id="no-b1-006-dup4",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007-dup4",skill="reading",difficulty="B1",question="Les: «Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var helligdag."],correct="Fordi direktøren var syk."),
AssessmentQuestion(id="no-b1-008-dup4",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin.",grammar_slug="ordstilling"),
AssessmentQuestion(id="no-b2-005-dup3",skill="grammar",difficulty="B2",question="Velg riktig leddsetning.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur.",grammar_slug="leddsetninger"),
AssessmentQuestion(id="no-b2-006-dup3",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva man tror vil skje","å forklare noe fra fortiden","å endre en regel","å avlyse en avtale"],correct="å si hva man tror vil skje"),
AssessmentQuestion(id="no-b2-007-dup3",skill="reading",difficulty="B2",question="Les: «Resultatene viser en tydelig tendens, men de bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],correct="Forsiktig tolkning av resultatene."),
AssessmentQuestion(id="no-b2-008-dup3",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner.",grammar_slug="indirekte-spørsmål"),
AssessmentQuestion(id="no-c1-005-dup4",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset er."],correct="Resultatene tyder på at effekten er begrenset.",grammar_slug="akademisk-språk"),
AssessmentQuestion(id="no-c1-006-dup4",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i akademisk sammenheng?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007-dup4",skill="reading",difficulty="C1",question="Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser korrelasjonen ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],correct="At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008-dup5",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Undersøkelsen ble gjennomført i tre trinn.","Undersøkelsen ble gjennomføre i tre trinn.","Undersøkelsen gjennomført ble i tre trinn.","Undersøkelsen ble gjennomført tre trinn."],correct="Undersøkelsen ble gjennomført i tre trinn.",grammar_slug="passiv"),
AssessmentQuestion(id="no-c2-005-dup5",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ingen grunn til å undersøke andre faktorer."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle.",grammar_slug="epistemisk-modalisering"),
AssessmentQuestion(id="no-c2-006-dup5",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],correct="som kan forstås på mer enn én måte"),
AssessmentQuestion(id="no-c2-007-dup5",skill="reading",difficulty="C2",question="Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],correct="At den underliggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008-dup5",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tillater ikke en entydig generalisering uten flere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisere uten flere.","Resultatene tillater en sikker generalisering uten analyse."],correct="Resultatene tillater ikke en entydig generalisering uten flere data.",grammar_slug="akademisk-stil")
AssessmentQuestion("no-a1-005-dup5","grammar","A1","Velg riktig spørsmål.",["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],"Hvor bor du?","questions"),
AssessmentQuestion("no-a1-006-dup5","vocabulary","A1","Hva betyr «eple»?",["en frukt","et kjøretøy","en bygning","et møbel"],"en frukt"),
AssessmentQuestion("no-a1-007-dup5","reading","A1","Les: «Kari bor i Bergen.» Hvor bor Kari?",["I Bergen.","I Oslo.","I Trondheim.","I Tromsø."],"I Bergen."),
AssessmentQuestion("no-a1-008-dup5","grammar","A1","Velg riktig form.",["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],"Hun har en bil.","en-og-et"),
AssessmentQuestion("no-a2-005-dup5","grammar","A2","Velg riktig preteritum.",["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går har jeg jobbet i går."],"I går jobbet jeg hjemme.","preteritum"),
AssessmentQuestion("no-a2-006-dup5","vocabulary","A2","Hva betyr «forsinkelse»?",["noe som kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],"noe som kommer senere enn planlagt"),
AssessmentQuestion("no-a2-007-dup5","reading","A2","Les: «Butikken stenger klokken seks.» Når stenger butikken?",["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],"Klokken seks."),
AssessmentQuestion("no-a2-008-dup5","grammar","A2","Velg riktig preposisjon.",["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor til Norge.","Jeg bor ved Norge."],"Jeg bor i Norge.","preposisjoner"),
AssessmentQuestion("no-b1-005-dup5","grammar","B1","Velg riktig relativsetning.",["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken jeg som kjøpte."],"Dette er boken som jeg kjøpte.","relativsetninger"),
AssessmentQuestion("no-b1-006-dup5","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
AssessmentQuestion("no-b1-007-dup5","reading","B1","Les: «Møtet ble utsatt fordi direktøren var syk.» Hvorfor ble møtet utsatt?",["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var en helligdag."],"Fordi direktøren var syk."),
AssessmentQuestion("no-b1-008-dup5","grammar","B1","Velg riktig ordstilling.",["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg var."],"I går kjøpte jeg en ny datamaskin.","ordstilling"),
AssessmentQuestion("no-b2-005-dup4","grammar","B2","Velg riktig innrømmende leddsetning.",["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],"Selv om det regnet, gikk vi en tur.","innrommende-leddsetninger"),
AssessmentQuestion("no-b2-006-dup4","vocabulary","B2","Hva betyr «forutsi»?",["å vurdere hva som vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],"å vurdere hva som vil skje"),
AssessmentQuestion("no-b2-007-dup4","reading","B2","Les: «Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],"Forsiktig tolkning av resultatene."),
AssessmentQuestion("no-b2-008-dup4","grammar","B2","Velg riktig indirekte spørsmål.",["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],"Jeg vet ikke når møtet begynner.","indirekte-spørsmål"),
AssessmentQuestion("no-c1-005-dup5","grammar","C1","Velg den mest presise akademiske formuleringen.",["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],"Resultatene tyder på at effekten er begrenset.","akademisk-språk"),
AssessmentQuestion("no-c1-006-dup5","vocabulary","C1","Hva betyr «vesentlig» i en akademisk tekst?",["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],"betydningsfull eller viktig"),
AssessmentQuestion("no-c1-007-dup5","reading","C1","Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser korrelasjonen ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At det er gjort en analyse."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-008-dup6","grammar","C1","Velg riktig passiv konstruksjon.",["Undersøkelsen ble gjennomført i tre trinn.","Undersøkelsen ble gjennomføre i tre trinn.","Undersøkelsen gjennomført ble i tre trinn.","Undersøkelsen ble gjennomførte i tre trinn."],"Undersøkelsen ble gjennomført i tre trinn.","passiv"),
AssessmentQuestion("no-c2-005-dup6","grammar","C2","Hvilken formulering uttrykker vitenskapelig forsiktighet?",["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Andre faktorer trenger ikke å undersøkes."],"Det kan ikke utelukkes at andre faktorer spiller en rolle.","epistemisk-modalisering"),
AssessmentQuestion("no-c2-006-dup6","vocabulary","C2","Hva betyr «tvetydig»?",["som kan forstås på flere måter","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på flere måter"),
AssessmentQuestion("no-c2-007-dup6","reading","C2","Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion("no-c2-008-dup6","grammar","C2","Velg den mest presise akademiske formuleringen.",["Resultatene gir ikke grunnlag for en sikker generalisering uten flere data.","Resultatene gir alltid grunnlag for generalisering uten data.","Resultatene gir ikke grunnlag for å generalisere uten flere.","Resultatene gir grunnlag for sikker generalisering uten analyse."],"Resultatene gir ikke grunnlag for en sikker generalisering uten flere data.","akademisk-formulering")
 
AssessmentQuestion("no-a1-009-dup3","grammar","A1","Velg riktig setning.",["Jeg er trøtt.","Jeg er trøtte.","Jeg være trøtt.","Jeg er trøtt er."],"Jeg er trøtt.","være"),
AssessmentQuestion("no-a1-010-dup3","reading","A1","Les: «Sara bor i Bergen.» Hvor bor Sara?",["I Bergen.","I Oslo.","I Trondheim.","I Tromsø."],"I Bergen."),
AssessmentQuestion("no-a2-009-dup3","grammar","A2","Velg riktig preteritum.",["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går jobbet hjemme jeg."],"I går jobbet jeg hjemme.","preteritum"),
AssessmentQuestion("no-a2-010-dup3","vocabulary","A2","Hva betyr «avtale»?",["et avtalt tidspunkt eller møte","en forsinkelse","en bygning","et kjøretøy"],"et avtalt tidspunkt eller møte"),
AssessmentQuestion("no-b1-009-dup3","grammar","B1","Velg riktig betingelsessetning.",["Hvis jeg hadde tid, ville jeg reist.","Hvis jeg har tid, ville jeg reist i går.","Hvis jeg hadde tid, reiste jeg i morgen.","Hvis jeg ha tid, ville jeg reist."],"Hvis jeg hadde tid, ville jeg reist.","betingelser"),
AssessmentQuestion("no-b1-010-dup3","reading","B1","Les: «Møtet ble utsatt fordi direktøren var syk.» Hvorfor ble møtet utsatt?",["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var helligdag."],"Fordi direktøren var syk."),
AssessmentQuestion("no-b2-009-dup3","grammar","B2","Velg riktig innrømmende konstruksjon.",["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],"Selv om det regnet, gikk vi en tur.","innroemmelse"),
AssessmentQuestion("no-b2-010-dup3","vocabulary","B2","Hva betyr «nyansere»?",["å gjøre en påstand mer presis og mindre absolutt","å avlyse en avtale","å oversette en tekst","å betale en regning"],"å gjøre en påstand mer presis og mindre absolutt"),
AssessmentQuestion("no-c1-009-dup3","grammar","C1","Velg den mest naturlige akademiske formuleringen.",["Funnene tyder på at videre analyse er nødvendig.","Funnene tyder på at videre analyse er nødvendige.","Funnene tyder videre analyse på at nødvendig er.","Funnene tyder at videre analyse nødvendig."],"Funnene tyder på at videre analyse er nødvendig.","akademisk-språk"),
AssessmentQuestion("no-c1-010-dup3","reading","C1","Les: «Dataene er forenlige med hypotesen, men gir ikke et endelig bevis.» Hva mangler?",["Et endelig bevis.","Data.","En hypotese.","En sammenligning."],"Et endelig bevis."),
AssessmentQuestion("no-c2-009-dup3","grammar","C2","Hvilken formulering uttrykker tydeligst et forbehold?",["Så langt de tilgjengelige dataene tillater det, synes konklusjonen å være berettiget.","Konklusjonen er uten tvil alltid riktig.","Konklusjonen kan under ingen omstendighet endres.","Det er ingen grunn til å undersøke alternative forklaringer."],"Så langt de tilgjengelige dataene tillater det, synes konklusjonen å være berettiget.","epistemisk-modalisering"),
AssessmentQuestion("no-c2-010-dup3","vocabulary","C2","Hva betyr «forbehold» i en argumentasjon?",["en begrensning eller presisering av en påstand","et endelig bevis","en gjentakelse","en uformell hilsen"],"en begrensning eller presisering av en påstand")

AssessmentQuestion(id="no-b1-005-dup6",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken jeg som kjøpte."],correct="Dette er boken som jeg kjøpte."),
AssessmentQuestion(id="no-b1-006-dup6",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007-dup6",skill="reading",difficulty="B1",question="«Møtet ble flyttet fordi lederen var syk.» Hvorfor ble møtet flyttet?",options=["Fordi lederen var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var ferie."],correct="Fordi lederen var syk."),
AssessmentQuestion(id="no-b1-008-dup6",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion(id="no-b2-005-dup5",skill="grammar",difficulty="B2",question="Velg riktig leddsetning som uttrykker kontrast.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur."),
AssessmentQuestion(id="no-b2-006-dup5",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva man tror vil skje","å forklare fortiden","å endre en regel","å avlyse en avtale"],correct="å si hva man tror vil skje"),
AssessmentQuestion(id="no-b2-007-dup5",skill="reading",difficulty="B2",question="«Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen."],correct="Forsiktig tolkning av resultatene."),
AssessmentQuestion(id="no-b2-008-dup5",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner."),
AssessmentQuestion(id="no-c1-005-dup6",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],correct="Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion(id="no-c1-006-dup6",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en akademisk tekst?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007-dup6",skill="reading",difficulty="C1",question="«Korrelasjon alene beviser ikke en årsakssammenheng.» Hva beviser korrelasjon ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er utført."],correct="At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008-dup7",skill="grammar",difficulty="C1",question="Velg riktig passivkonstruksjon.",options=["Undersøkelsen ble gjennomført i tre trinn.","Undersøkelsen ble gjennomføre i tre trinn.","Undersøkelsen gjennomført ble i tre trinn.","Undersøkelsen ble gjennomførte i tre trinn."],correct="Undersøkelsen ble gjennomført i tre trinn."),
AssessmentQuestion(id="no-c2-005-dup7",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Andre faktorer trenger ikke å undersøkes."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle."),
AssessmentQuestion(id="no-c2-006-dup7",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],correct="som kan forstås på mer enn én måte"),
AssessmentQuestion(id="no-c2-007-dup7",skill="reading",difficulty="C2",question="«Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],correct="At den underliggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008-dup7",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tillater ikke en entydig generalisering uten flere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisere uten flere.","Resultatene tillater en sikker generalisering uten analyse."],correct="Resultatene tillater ikke en entydig generalisering uten flere data.")
]
