...
AssessmentQuestion(id="no-a1-005",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],correct="Hvor bor du?",grammar_slug="spørsmål"),AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="Les: «Sara bor i Bergen.» Hvor bor Sara?",options=["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],correct="I Bergen."),AssessmentQuestion(id="no-a1-008",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun har en biler.","Hun ha en bil."],correct="Hun har en bil.",grammar_slug="en-et"),AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig preteritum.",options=["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går har jeg jobbe."],correct="I går jobbet jeg hjemme.",grammar_slug="preteritum"),AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["noe som skjer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="noe som skjer senere enn planlagt"),AssessmentQuestion(id="no-a2-007",skill="reading",difficulty="A2",question="Les: «Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),AssessmentQuestion(id="no-a2-008",skill="grammar",difficulty="A2",question="Velg riktig setning.",options=["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor i Norge?","Jeg bor Norge i."],correct="Jeg bor i Norge.",grammar_slug="preposisjoner"),AssessmentQuestion(id="no-b1-005",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Det er boken som jeg kjøpte.","Det er boken som jeg kjøpt.","Det er boken jeg som kjøpte.","Det er boken som kjøpte jeg."],correct="Det er boken som jeg kjøpte.",grammar_slug="relativsetninger"),AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),AssessmentQuestion(id="no-b1-007",skill="reading",difficulty="B1",question="Les: «Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var helligdag."],correct="Fordi direktøren var syk."),AssessmentQuestion(id="no-b1-008",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin.",grammar_slug="ordstilling"),AssessmentQuestion(id="no-b2-005",skill="grammar",difficulty="B2",question="Velg riktig leddsetning med innrømmelse.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur.",grammar_slug="innroemmelse"),AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva man tror vil skje","å forklare fortiden","å endre en regel","å avlyse en avtale"],correct="å si hva man tror vil skje"),AssessmentQuestion(id="no-b2-007",skill="reading",difficulty="B2",question="Les: «Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],correct="Forsiktig tolkning av resultatene."),AssessmentQuestion(id="no-b2-008",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner.",grammar_slug="indirekte-spoersmaal"),AssessmentQuestion(id="no-c1-005",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder at effekten på er begrenset."],correct="Resultatene tyder på at effekten er begrenset.",grammar_slug="akademisk-sprak"),AssessmentQuestion(id="no-c1-006",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en akademisk tekst?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),AssessmentQuestion(id="no-c1-007",skill="reading",difficulty="C1",question="Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser korrelasjon ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],"At det ene fenomenet forårsaker det andre."),AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomførte i tre faser."],"Studien ble gjennomført i tre faser.",grammar_slug="passiv"),AssessmentQuestion(id="no-c2-005",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ikke nødvendig å undersøke andre faktorer."],"Det kan ikke utelukkes at andre faktorer spiller en rolle.",grammar_slug="epistemisk-modalitet"),AssessmentQuestion(id="no-c2-006",skill="vocabulary",difficulty="C2",question="Hva betyr «tvetydig»?",options=["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på mer enn én måte"),AssessmentQuestion(id="no-c2-007",skill="reading",difficulty="C2",question="Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At teksten er kort.","At stilen er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),AssessmentQuestion(id="no-c2-008",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tillater ikke en entydig generalisering uten ytterligere data.","Resultatene tillater alltid generalisering uten data.","Resultatene tillater ikke å generalisere uten ytterligere.","Resultatene tillater en entydig generalisering uten analyse."],"Resultatene tillater ikke en entydig generalisering uten ytterligere data.",grammar_slug="akademisk-formulering")
]
