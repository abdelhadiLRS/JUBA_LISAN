...
AssessmentQuestion("no-a1-005","grammar","A1","Velg riktig spørsmål.",["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],"Hvor bor du?","spørsmål"),
AssessmentQuestion("no-a1-006","vocabulary","A1","Hva betyr «eple»?",["en frukt","et kjøretøy","en bygning","et møbel"],"en frukt"),
AssessmentQuestion("no-a1-007","reading","A1","Les: «Anna bor i Bergen.» Hvor bor Anna?",["I Bergen.","I Oslo.","I Trondheim.","I Tromsø."],"I Bergen."),
AssessmentQuestion("no-a1-008","grammar","A1","Velg riktig form.",["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],"Hun har en bil.","substantiv"),
...
AssessmentQuestion("no-b1-005","grammar","B1","Velg riktig relativsetning.",["Dette er boka som jeg kjøpte.","Dette er boka som jeg kjøpt.","Dette er boka som kjøpte jeg.","Dette er boka jeg som kjøpte."],"Dette er boka som jeg kjøpte.","relativsetninger"),
AssessmentQuestion("no-b1-006","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
...
AssessmentQuestion("no-b1-008","grammar","B1","Velg riktig ordstilling.",["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin jeg kjøpte."],"I går kjøpte jeg en ny datamaskin.","ordstilling"),
AssessmentQuestion("no-b2-005","grammar","B2","Velg riktig innrømmende leddsetning.",["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],"Selv om det regnet, gikk vi en tur.","leddsetninger"),
AssessmentQuestion("no-b2-006","vocabulary","B2","Hva betyr «forutsi»?",["å vurdere hva som sannsynligvis vil skje","å forklare fortiden","å endre en regel","å avlyse et møte"],"å vurdere hva som sannsynligvis vil skje"),
...
AssessmentQuestion("no-c1-007","reading","C1","Les: «Korrelasjon alene beviser ikke et årsaksforhold.» Hva bevises ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-008","grammar","C1","Velg riktig passiv konstruksjon.",["Undersøkelsen ble gjennomført i tre trinn.","Undersøkelsen ble gjennomføre i tre trinn.","Undersøkelsen gjennomført ble i tre trinn.","Undersøkelsen ble gjennomført tre trinn."],"Undersøkelsen ble gjennomført i tre trinn.","passiv"),
...
AssessmentQuestion("no-c2-006","vocabulary","C2","Hva betyr «tvetydig»?",["som kan forstås på mer enn én måte","som er helt entydig","som er svært kort","som er lett å måle"],"som kan forstås på mer enn én måte"),
AssessmentQuestion("no-c2-007","reading","C2","Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",["At den underliggende antakelsen holder.","At argumentet er kort.","At teksten er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion("no-c2-008","grammar","C2","Velg den mest presise akademiske formuleringen.",["Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.","Resultatene gir alltid grunnlag for generalisering uten data.","Resultatene gir ikke grunnlag å generalisere uten flere.","Resultatene gir grunnlag for sikker generalisering uten analyse."],"Resultatene gir ikke grunnlag for en entydig generalisering uten flere data.","akademisk-formulering")
...
AssessmentQuestion("no-b1-005","grammar","B1","Velg riktig relativsetning.",["Dette er boka som jeg kjøpte.","Dette er boka som jeg kjøpt.","Dette er boka som kjøpte jeg.","Dette er boka som jeg kjøpte den."],"Dette er boka som jeg kjøpte."),
AssessmentQuestion("no-b1-006","vocabulary","B1","Hva betyr «utfordring»?",["noe som krever innsats","en belønning","en ferie","en adresse"],"noe som krever innsats"),
...
AssessmentQuestion("no-c1-005","grammar","C1","Velg den mest presise formuleringen.",["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset."],"Resultatene tyder på at effekten er begrenset.","akademisk-språk"),
AssessmentQuestion("no-c1-006","vocabulary","C1","Hva betyr «vesentlig» i akademisk sammenheng?",["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],"betydningsfull eller viktig"),
AssessmentQuestion("no-c1-007","reading","C1","Les: «Korrelasjon alene beviser ikke et årsaksforhold.» Hva bevises ikke?",["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjennomført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion("no-c1-008","grammar","C1","Velg riktig passiv konstruksjon.",["Undersøkelsen ble gjennomført i tre trinn.","Undersøkelsen ble gjennomføre i tre trinn.","Undersøkelsen gjennomført ble i tre trinn.","Undersøkelsen ble gjennomført tre trinn."],"Undersøkelsen ble gjennomført i tre trinn.","passiv"),
AssessmentQuestion("no-c2-005","grammar","C2","Hvilken formulering uttrykker akademisk forsiktighet?",["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ingen grunn til å undersøke andre faktorer."],"Det kan ikke utelukkes at andre faktorer spiller en rolle.","epistemisk-modalisering"),
