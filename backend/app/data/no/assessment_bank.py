...
AssessmentQuestion(id="no-a1-005",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bo?"],correct="Hvor bor du?"),
AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="Les: «Kari bor i Bergen.» Hvor bor Kari?",options=["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],correct="I Bergen."),
AssessmentQuestion(id="no-a1-008",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Han har en bil.","Han har et bil.","Han ha en bil.","Han har en biler."],correct="Han har en bil."),
AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig fortidsform.",options=["I går jobbet jeg hjemme.","I går jobber jeg hjemme.","I går jobbe jeg hjemme.","I går har jeg jobbe."],correct="I går jobbet jeg hjemme."),
AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["noe som kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="noe som kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007",skill="reading",difficulty="A2",question="Les: «Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
...
AssessmentQuestion(id="no-b1-005",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken som kjøpte jeg.","Dette er boken som jeg kjøpe."],correct="Dette er boken som jeg kjøpte."),
AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
...
AssessmentQuestion(id="no-b2-005",skill="grammar",difficulty="B2",question="Velg riktig innrømmende setning.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur."),
...
AssessmentQuestion(id="no-c1-007",skill="reading",difficulty="C1",question="Les: «Korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva bevises ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er gjort."],correct="At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passiv konstruksjon.",options=["Studien ble gjennomført i tre trinn.","Studien ble gjennomføre i tre trinn.","Studien gjennomførte i tre trinn.","Studien ble gjennomført tre trinn."],correct="Studien ble gjennomført i tre trinn."),
AssessmentQuestion(id="no-c2-005",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker akademisk forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er ikke nødvendig å undersøke andre faktorer."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle."),
