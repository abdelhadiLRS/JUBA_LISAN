...
AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="Les: «Erik bor i Bergen.» Hvor bor Erik?",options=["I Bergen.","I Oslo.","I Trondheim.","I Stavanger."],correct="I Bergen."),
...
AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever en innsats","en belønning","en ferie","en adresse"],correct="noe som krever en innsats"),
...
AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å anslå hva som vil skje i framtiden","å forklare fortiden","å endre en regel","å avlyse en avtale"],correct="å anslå hva som vil skje i framtiden"),
...
AssessmentQuestion(id="no-c1-005",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset er."],correct="Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion(id="no-c1-006",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en faglig sammenheng?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007",skill="reading",difficulty="C1",question="Les: «En korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser den ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er utført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passivkonstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomførte i tre faser.","Studien gjennomføre ble i tre faser.","Studien ble gjennomført i tre fase."],correct="Studien ble gjennomført i tre faser."),
AssessmentQuestion(id="no-c2-005",skill="grammar",difficulty="C2",question="Hvilken formulering uttrykker faglig forsiktighet?",options=["Det kan ikke utelukkes at andre faktorer spiller en rolle.","Andre faktorer spiller helt sikkert ingen rolle.","Det er bevist uten unntak at andre faktorer er irrelevante.","Det er unødvendig å undersøke andre faktorer."],correct="Det kan ikke utelukkes at andre faktorer spiller en rolle."),
...
AssessmentQuestion(id="no-c2-007",skill="reading",difficulty="C2",question="Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen stemmer.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen stemmer.","At teksten er kort.","At stilen er uformell.","At dataene er gamle."],"At den underliggende antakelsen stemmer."),
AssessmentQuestion(id="no-c2-008",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Funnene gir ikke grunnlag for en sikker generalisering uten flere data.","Funnene gir alltid grunnlag for generalisering uten data.","Funnene gir ikke grunnlag for generalisere uten flere.","Funnene beviser konklusjonen uten analyse."],"Funnene gir ikke grunnlag for en sikker generalisering uten flere data.")
