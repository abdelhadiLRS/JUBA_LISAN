...
AssessmentQuestion(id="no-a1-029",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],correct="Hvor bor du?"),
AssessmentQuestion(id="no-a1-030",skill="reading",difficulty="A1",question="Les: «Lise drikker melk.» Hva drikker Lise?",options=["Melk.","Kaffe.","Te.","Vann."],correct="Melk."),
AssessmentQuestion(id="no-a2-029",skill="grammar",difficulty="A2",question="Velg riktig framtidsform.",options=["Jeg skal besøke familien i morgen.","Jeg skal besøker familien i morgen.","Jeg skal besøkte familien i morgen.","Jeg besøker skal familien i morgen."],correct="Jeg skal besøke familien i morgen."),
AssessmentQuestion(id="no-a2-030",skill="reading",difficulty="A2",question="Les: «Biblioteket åpner klokken ni på lørdag.» Når åpner biblioteket?",options=["Klokken ni.","Klokken åtte.","Klokken ti.","Klokken elleve."],correct="Klokken ni."),
AssessmentQuestion(id="no-b1-029",skill="grammar",difficulty="B1",question="Velg riktig setning med «selv om».",options=["Selv om det regnet, gikk vi ut.","Selv om det regnet, vi gikk ut.","Selv om regnet det, gikk vi ut.","Selv om det regnet, vi ut gikk."],correct="Selv om det regnet, gikk vi ut."),
AssessmentQuestion(id="no-b1-030",skill="reading",difficulty="B1",question="Les: «Hun tok bussen fordi bilen var på verksted.» Hvorfor tok hun bussen?",options=["Fordi bilen var på verksted.","Fordi hun ikke hadde billett.","Fordi bussen var gratis.","Fordi hun skulle gå."],correct="Fordi bilen var på verksted."),
AssessmentQuestion(id="no-b2-029",skill="grammar",difficulty="B2",question="Velg korrekt indirekte spørsmål.",options=["Jeg lurer på hvorfor møtet ble utsatt.","Jeg lurer på hvorfor ble møtet utsatt.","Jeg lurer hvorfor møtet ble utsatt?","Jeg lurer på møtet hvorfor ble utsatt."],correct="Jeg lurer på hvorfor møtet ble utsatt."),
AssessmentQuestion(id="no-b2-030",skill="reading",difficulty="B2",question="Les: «Rapporten peker på en sammenheng, men understreker at årsaken ikke er fastslått.» Hva er ikke fastslått?",options=["Årsaken.","At rapporten finnes.","At en sammenheng er omtalt.","At data er samlet inn."],"Årsaken."),
