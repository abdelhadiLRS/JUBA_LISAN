...
AssessmentQuestion(id="no-a1-006",skill="vocabulary",difficulty="A1",question="Hva betyr «eple»?",options=["en frukt","et kjøretøy","en bygning","et møbel"],correct="en frukt"),
AssessmentQuestion(id="no-a1-007",skill="reading",difficulty="A1",question="Les: «Erik bor i Bergen.» Hvor bor Erik?",options=["Bergen","Oslo","Trondheim","Stavanger"],correct="Bergen"),
...
AssessmentQuestion(id="no-a2-005",skill="grammar",difficulty="A2",question="Velg riktig presens perfektum.",options=["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spiser har."],correct="Jeg har spist."),
AssessmentQuestion(id="no-a2-006",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en bestilling","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-007",skill="reading",difficulty="A2",question="Les: «Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
...
AssessmentQuestion(id="no-b1-005",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boka som jeg kjøpte.","Dette er boka som jeg kjøpt.","Dette er boka som kjøpte jeg.","Dette er boka jeg som kjøpte."],correct="Dette er boka som jeg kjøpte."),
AssessmentQuestion(id="no-b1-006",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-007",skill="reading",difficulty="B1",question="Les: «Møtet ble flyttet fordi lederen var syk.» Hvorfor ble møtet flyttet?",options=["Fordi lederen var syk.","Fordi kontoret var stengt.","Fordi toget var forsinket.","Fordi det var en fridag."],correct="Fordi lederen var syk."),
...
AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å anslå hva som vil skje","å forklare noe fra fortiden","å endre en regel","å avlyse en avtale"],correct="å anslå hva som vil skje"),
AssessmentQuestion(id="no-b2-007",skill="reading",difficulty="B2",question="Les: «Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",options=["Å tolke resultatene forsiktig.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],"Å tolke resultatene forsiktig."),
AssessmentQuestion(id="no-b2-008",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],"Jeg vet ikke når møtet begynner."),
AssessmentQuestion(id="no-c1-005",skill="grammar",difficulty="C1",question="Velg den mest presise akademiske formuleringen.",options=["Resultatene tyder på at effekten er begrenset.","Resultatene tyder at effekten er begrenset.","Resultatene tyder på effekten at er begrenset.","Resultatene tyder på at effekten begrenset er."],"Resultatene tyder på at effekten er begrenset."),
AssessmentQuestion(id="no-c1-006",skill="vocabulary",difficulty="C1",question="Hva betyr «vesentlig» i en fagtekst?",options=["betydningsfull eller viktig","tilfeldig","midlertidig","uformell"],correct="betydningsfull eller viktig"),
AssessmentQuestion(id="no-c1-007",skill="reading",difficulty="C1",question="Les: «En korrelasjon beviser ikke i seg selv en årsakssammenheng.» Hva beviser korrelasjonen ikke?",options=["At det ene fenomenet forårsaker det andre.","At det finnes data.","At variablene henger sammen.","At en analyse er utført."],"At det ene fenomenet forårsaker det andre."),
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passivkonstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomførte i tre faser."],"Studien ble gjennomført i tre faser."),
...
AssessmentQuestion(id="no-c2-007",skill="reading",difficulty="C2",question="Les: «Argumentet er overbevisende, forutsatt at den underliggende antakelsen holder.» Hva avhenger vurderingen av?",options=["At den underliggende antakelsen holder.","At teksten er kort.","At stilen er uformell.","At dataene er gamle."],"At den underliggende antakelsen holder."),
AssessmentQuestion(id="no-c2-008",skill="grammar",difficulty="C2",question="Velg den mest presise akademiske formuleringen.",options=["Funnene gir ikke grunnlag for en sikker generalisering uten flere data.","Funnene gir alltid grunnlag for generalisering uten data.","Funnene gir ikke grunnlag for å generalisere flere data.","Funnene gir grunnlag for en sikker generalisering uten analyse."],"Funnene gir ikke grunnlag for en sikker generalisering uten flere data.")
