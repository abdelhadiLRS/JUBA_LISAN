...
AssessmentQuestion(id="no-b2-005",skill="grammar",difficulty="B2",question="Velg riktig innrømmende leddsetning.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur."),
AssessmentQuestion(id="no-b2-006",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å anslå hva som vil skje senere","å forklare fortiden","å endre en regel","å avlyse en avtale"],correct="å anslå hva som vil skje senere"),
AssessmentQuestion(id="no-b2-007",skill="reading",difficulty="B2",question="Les: «Resultatene viser en tydelig tendens, men bør tolkes med forsiktighet.» Hva anbefales?",options=["Å tolke resultatene forsiktig.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen straks."],correct="Å tolke resultatene forsiktig."),
...
AssessmentQuestion(id="no-c1-008",skill="grammar",difficulty="C1",question="Velg riktig passivkonstruksjon.",options=["Studien ble gjennomført i tre faser.","Studien ble gjennomføre i tre faser.","Studien gjennomført ble i tre faser.","Studien ble gjennomførte i tre faser."],correct="Studien ble gjennomført i tre faser."),
