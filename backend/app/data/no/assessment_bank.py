...
AssessmentQuestion(id="no-a1-009",skill="grammar",difficulty="A1",question="Velg riktig spørsmål.",options=["Hvor bor du?","Hvor du bor?","Bor hvor du?","Hvor bor?"],correct="Hvor bor du?"),
...
AssessmentQuestion(id="no-a1-011",skill="reading",difficulty="A1",question="«Kari bor i Bergen.» Hvor bor Kari?",options=["Bergen","Oslo","Stavanger","Tromsø"],correct="Bergen"),
AssessmentQuestion(id="no-a1-012",skill="grammar",difficulty="A1",question="Velg riktig form.",options=["Hun har en bil.","Hun har et bil.","Hun ha en bil.","Hun har en biler."],correct="Hun har en bil."),
AssessmentQuestion(id="no-a2-009",skill="grammar",difficulty="A2",question="Velg riktig perfektum.",options=["Jeg har spist.","Jeg har spise.","Jeg har spiste.","Jeg spiser har."],correct="Jeg har spist."),
AssessmentQuestion(id="no-a2-010",skill="vocabulary",difficulty="A2",question="Hva betyr «forsinkelse»?",options=["at noe kommer senere enn planlagt","en reservasjon","en adresse","en betaling"],correct="at noe kommer senere enn planlagt"),
AssessmentQuestion(id="no-a2-011",skill="reading",difficulty="A2",question="«Butikken stenger klokken seks.» Når stenger butikken?",options=["Klokken fem.","Klokken seks.","Klokken sju.","Klokken åtte."],correct="Klokken seks."),
AssessmentQuestion(id="no-a2-012",skill="grammar",difficulty="A2",question="Velg riktig preposisjon.",options=["Jeg bor i Norge.","Jeg bor på Norge.","Jeg bor til Norge.","Jeg bor ved Norge."],correct="Jeg bor i Norge."),
AssessmentQuestion(id="no-b1-009",skill="grammar",difficulty="B1",question="Velg riktig relativsetning.",options=["Dette er boken som jeg kjøpte.","Dette er boken som jeg kjøpt.","Dette er boken jeg som kjøpte.","Dette er boken som kjøpte jeg."],correct="Dette er boken som jeg kjøpte."),
AssessmentQuestion(id="no-b1-010",skill="vocabulary",difficulty="B1",question="Hva betyr «utfordring»?",options=["noe som krever innsats","en belønning","en ferie","en adresse"],correct="noe som krever innsats"),
AssessmentQuestion(id="no-b1-011",skill="reading",difficulty="B1",question="«Møtet ble flyttet fordi direktøren var syk.» Hvorfor ble møtet flyttet?",options=["Fordi direktøren var syk.","Fordi lokalet var stengt.","Fordi toget var forsinket.","Fordi deltakerne hadde ferie."],correct="Fordi direktøren var syk."),
AssessmentQuestion(id="no-b1-012",skill="grammar",difficulty="B1",question="Velg riktig ordstilling.",options=["I går kjøpte jeg en ny datamaskin.","I går jeg kjøpte en ny datamaskin.","I går kjøpte en ny datamaskin jeg.","I går en ny datamaskin kjøpte jeg."],correct="I går kjøpte jeg en ny datamaskin."),
AssessmentQuestion(id="no-b2-009",skill="grammar",difficulty="B2",question="Velg riktig innrømmende leddsetning.",options=["Selv om det regnet, gikk vi en tur.","Selv om det regnet, vi gikk en tur.","Selv om regnet det, gikk vi en tur.","Selv om det regnet, vi en tur gikk."],correct="Selv om det regnet, gikk vi en tur."),
AssessmentQuestion(id="no-b2-010",skill="vocabulary",difficulty="B2",question="Hva betyr «forutsi»?",options=["å si hva man forventer vil skje","å forklare noe fra fortiden","å endre en regel","å avlyse en avtale"],correct="å si hva man forventer vil skje"),
AssessmentQuestion(id="no-b2-011",skill="reading",difficulty="B2",question="«Resultatene viser en tydelig tendens, men de bør tolkes med forsiktighet.» Hva anbefales?",options=["Forsiktig tolkning av resultatene.","Å ignorere resultatene.","Å endre alle resultatene.","Å avslutte undersøkelsen."],correct="Forsiktig tolkning av resultatene."),
AssessmentQuestion(id="no-b2-012",skill="grammar",difficulty="B2",question="Velg riktig indirekte spørsmål.",options=["Jeg vet ikke når møtet begynner.","Jeg vet ikke når begynner møtet.","Jeg vet ikke når møtet begynner?","Jeg vet ikke møtet når begynner."],correct="Jeg vet ikke når møtet begynner."),
