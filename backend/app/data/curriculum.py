...
_LANG_MODULES: dict[str, str] = {
    ...
    "fy": "app.data.language_foundations.fy",
    "co": "app.data.language_foundations.co",
    "fa": "app.data.language_foundations.fa",
    "fil": "app.data.language_foundations.fil",
    "hi": "app.data.language_foundations.hi",
    "th": "app.data.language_foundations.th",
    "bs": "app.data.language_foundations.bs",
    "tk": "app.data.language_foundations.tk",
    "bn": "app.data.language_foundations.bn",
    "mn": "app.data.language_foundations.mn",
    "ku": "app.data.language_foundations.ku",
    "lo": "app.data.language_foundations.lo",
    "jv": "app.data.language_foundations.jv",
    "as": "app.data.language_foundations.as",
    "ay": "app.data.language_foundations.ay",
    "be": "app.data.language_foundations.be",
    "bo": "app.data.language_foundations.bo",
    "ca": "app.data.language_foundations.ca",
    "ee": "app.data.language_foundations.ee",
    "dz": "app.data.language_foundations.dz",
    "et": "app.data.language_foundations.et",
    "fj": "app.data.language_foundations.fj",
    "gn": "app.data.language_foundations.gn",
    "or": "app.data.language_foundations.or",
    "tg": "app.data.language_foundations.tg",
    "su": "app.data.language_foundations.su",
...
def _resolve_module(target_language: str) -> object:
    ...
    module_name = _LANG_MODULES.get(canonical)
    if module_name is None:
        # Regional variants share foundation/core curriculum data unless a
        # dedicated module is registered explicitly.
        module_name = _LANG_MODULES.get(resolution.base, "app.data.en_GB.curriculum")
