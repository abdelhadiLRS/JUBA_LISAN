...
AssessmentQuestion(id="su-c1-014",skill="register",difficulty="C1",question="Which expression is suitable for a formal request?",options=["Mangga tampi pamundut abdi.","Vérsi pondokna kumaha?","Saha?","Hayu urang indit!"],correct="Mangga tampi pamundut abdi."),
]
