...
ASSESSMENT_BANK = [
    ...
    AssessmentQuestion(id="ka-b2-002",skill="style",difficulty="B2",question="Which phrase suits formal communication?",options=["გთხოვთ, გაითვალისწინოთ აღნიშნული საკითხი.","გამარჯობა!","რა ღირს?","ნახვამდის!"],correct="გთხოვთ, გაითვალისწინოთ აღნიშნული საკითხი."),
    ...
    AssessmentQuestion(id="ka-c2-001",skill="style",difficulty="C2",question="Which connector means “on the other hand”?",options=["მეორე მხრივ","ერთი მხრივ","მადლობა","ხვალ"],correct="მეორე მხრივ"),
    ...
    AssessmentQuestion(id="ka-c2-003",skill="style",difficulty="C2",question="Which phrase works as a formal conclusion?",options=["საბოლოო ჯამში...","გამარჯობა!","სად არის ტუალეტი?","წყალი მინდა."],correct="საბოლოო ჯამში..."),
]
