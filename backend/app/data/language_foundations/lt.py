...
ASSESSMENT_BANK = [
    ...
    AssessmentQuestion(id="lt-a1-002", skill="communication", difficulty="A1", question="Which sentence means 'I am a student'?", options=["Aš esu studentas.","Aš gyvenu Vilniuje.","Aš turiu brolį.","Aš dirbu namuose."], correct="Aš esu studentas."),
    ...
    AssessmentQuestion(id="lt-a2-002", skill="communication", difficulty="A2", question="How do you ask when the bus leaves?", options=["Kada išvyksta autobusas?","Kur gyveni?","Kiek tai kainuoja?","Kaip sekasi?"], correct="Kada išvyksta autobusas?"),
    ...
    AssessmentQuestion(id="lt-b1-002", skill="discourse", difficulty="B1", question="Which word means 'conclusion'?", options=["išvada","prielaida","pasekmė","atsakomybė"], correct="išvada"),
    ...
    AssessmentQuestion(id="lt-c2-002", skill="pragmatics", difficulty="C2", question="Which word describes a subtle stylistic difference?", options=["subtilus","garsus","kasdienis","greitas"], correct="subtilus"),
]
