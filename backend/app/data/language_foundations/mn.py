...
GRAMMAR_TOPICS = [
    ...
    g("present", "Present and habitual actions", "A1", "Describe current, habitual and general actions.", ["Би монгол хэл сурдаг.", "Тэр өдөр бүр ажилладаг."]),
...
CURRICULUM = {
    ...
    "B1": [
        ...
        u("B1", 6, "Үйл явдлын дараалал", ["converbs", "past"], "daily_a1", "Үйл явдлыг дараалуулна", "Үйл явцын явцыг тайлбарлана"),
