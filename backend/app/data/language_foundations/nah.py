...
ASSESSMENT_BANK=[
    AssessmentQuestion(id="nah-a1-001",skill="speaking",difficulty="A1",question="You meet a neighbor in the morning. Which Nahuatl greeting fits?",options=["hello","family","school","yesterday"],correct="hello"),
    AssessmentQuestion(id="nah-a1-002",skill="vocabulary",difficulty="A1",question="You introduce yourself. Which phrase completes the introduction?",options=["I am ...","family","school","yesterday"],correct="I am ..."),
    AssessmentQuestion(id="nah-a1-003",skill="grammar",difficulty="A1",question="You say who your brother is. Which phrase fits?",options=["my house","family","school","yesterday"],correct="my house"),
    AssessmentQuestion(id="nah-a1-004",skill="speaking",difficulty="A1",question="You say what you are eating. Which sentence fits?",options=["I eat","family","school","yesterday"],correct="I eat"),
    AssessmentQuestion(id="nah-a1-005",skill="vocabulary",difficulty="A1",question="You refer to today. Which expression fits?",options=["one day","family","school","yesterday"],correct="one day"),
    AssessmentQuestion(id="nah-a1-006",skill="grammar",difficulty="A1",question="You ask for water. Which phrase fits?",options=["tortilla","family","school","yesterday"],correct="tortilla"),
    AssessmentQuestion(id="nah-a1-007",skill="speaking",difficulty="A1",question="You say you are at home. Which expression fits?",options=["at home","family","school","yesterday"],correct="at home"),
    AssessmentQuestion(id="nah-a1-008",skill="vocabulary",difficulty="A1",question="You describe the day positively. Which expression fits?",options=["good/beautiful","family","school","yesterday"],correct="good/beautiful"),
    AssessmentQuestion(id="nah-a1-009",skill="reading",difficulty="A1",question="Which phrase is useful when meeting someone for the first time?",options=["Pialli","B2 academic term","technical formula","rare literary phrase"],correct="Pialli"),
    AssessmentQuestion(id="nah-a1-010",skill="production",difficulty="A1",question="Which phrase can end a simple polite exchange?",options=["cualtzin","technical term","advanced idiom","academic citation"],correct="cualtzin"),
]
