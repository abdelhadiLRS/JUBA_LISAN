...
ASSESSMENT_BANK = [
    ...
    AssessmentQuestion(id="ny-b2-002",skill="register",difficulty="B2",question="Which phrase fits a formal request?",options=["Tikukupemphani kuti mutitumizire...","Mpa ichi.","Moni.","Muli bwanji?"],correct="Tikukupemphani kuti mutitumizire..."),
    ...
    AssessmentQuestion(id="ny-c1-002",skill="professional",difficulty="C1",question="Which sentence is a formal institutional request?",options=["Tikukupemphani kuti mutitumizire zikalata zofunika.","Ndili kunyumba.","Ndikufuna madzi.","Muli bwanji?"],correct="Tikukupemphani kuti mutitumizire zikalata zofunika."),
