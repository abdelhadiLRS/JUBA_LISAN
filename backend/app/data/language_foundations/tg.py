...
PhrasebookCategory(id="academic",level="C1",situation="Academic discussion",icon="🎓",phrases=[PhrasebookEntry(text="Далелҳо нишон медиҳанд, ки...",context="introducing evidence",register="academic"),PhrasebookEntry(text="Аз ин рӯ, метавон ба чунин хулоса омад.",context="drawing a conclusion",register="academic"),PhrasebookEntry(text="Эҳтимол, ин натиҷа ба омилҳои дигар вобаста бошад.",context="hedging a claim",register="academic")]),
PhrasebookCategory(id="professional",level="C1",situation="Professional negotiation",icon="🤝",phrases=[PhrasebookEntry(text="Мо пешниҳод мекунем, ки...",context="proposal",register="formal"),PhrasebookEntry(text="Оё метавон ин шартро бозбинӣ кард?",context="negotiating",register="polite"),PhrasebookEntry(text="Биёед масъалаҳои асосиро муайян кунем.",context="setting an agenda",register="professional")]),
PhrasebookCategory(id="advanced",level="C2",situation="Advanced discourse",icon="🗣️",phrases=[PhrasebookEntry(text="Бо вуҷуди ин, масъала аз чанд ҷиҳат баҳснок аст.",context="qualified contrast",register="formal"),PhrasebookEntry(text="Ин мавқеъро бояд дар заминаи васеътари иҷтимоӣ баррасӣ кард.",context="contextualizing an argument",register="academic"),PhrasebookEntry(text="Агар зид набошед, мехостам як пешниҳод кунам.",context="polite advanced suggestion",register="formal")]),
]
_LEVEL_TOPICS={
