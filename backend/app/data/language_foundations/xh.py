...
PhrasebookCategory(id="xh-work",level="B1",situation="Work",icon="💼",phrases=[PhrasebookEntry(text="Masiqale intlanganiso.",context="Let's start the meeting.",register="formal"),PhrasebookEntry(text="Nceda unikeze ubungqina.",context="Please provide the evidence.",register="formal"),PhrasebookEntry(text="Siyavumelana ngalo mba.",context="We agree on this matter.",register="formal")]),
...
PhrasebookCategory(id="xh-academic",level="C1",situation="Academic writing",icon="📚",phrases=[PhrasebookEntry(text="Olu phando lubonisa ukuba...",context="This study shows that...",register="formal"),PhrasebookEntry(text="Oku kungabonisa...",context="This may indicate...",register="formal"),PhrasebookEntry(text="Uphando olongezelelekileyo luyafuneka.",context="Further research is needed.",register="formal")]),
...
PhrasebookCategory(id="xh-pragmatics",level="C2",situation="Nuance and pragmatics",icon="🎯",phrases=[PhrasebookEntry(text="Mhlawumbi singaphinda silijonge eli daba.",context="Perhaps we can reconsider this matter.",register="neutral"),PhrasebookEntry(text="Oku kuxhomekeke kumxholo.",context="This depends on the context.",register="formal"),PhrasebookEntry(text="Masiyibeke ngenye indlela.",context="Let's put it another way.",register="neutral")]),
]
...
AssessmentQuestion(id="xh-a1-002",skill="communication",difficulty="A1",question="Which sentence means I am Lwazi?",options=["NdinguLwazi.","Ndifuna le.","Nceda undincede.","Enkosi kakhulu."],correct="NdinguLwazi."),
...
AssessmentQuestion(id="xh-a1-004",skill="communication",difficulty="A1",question="How do you ask the price?",options=["Ixabisa malini le?","Uhlala phi?","Ndiyaphila.","Nceda undincede."],correct="Ixabisa malini le?"),
