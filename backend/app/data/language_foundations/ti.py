...
ASSESSMENT_BANK=[
    AssessmentQuestion(id="ti-a1-001",skill="speaking",difficulty="A1",question="You greet someone. Which Tigrinya phrase is a natural greeting?",options=["ሰላም፣ ከመይ ኣለኻ?","ማይ እሰቲ።","ሎሚ ሰኑይ እዩ።","ኣብ ገዛ ኣለኹ።"],correct="ሰላም፣ ከመይ ኣለኻ?"),
    AssessmentQuestion(id="ti-a1-002",skill="communication",difficulty="A1",question="You introduce yourself. Which Tigrinya sentence gives your name?",options=["ስመይ ሚካኤል እዩ።","ሎሚ ሰኑይ እዩ።","ማይ እሰቲ።","የቐንየለይ ንሓገዝካ።"],correct="ስመይ ሚካኤል እዩ።"),
    AssessmentQuestion(id="ti-a1-003",skill="grammar",difficulty="A1",question="You talk about your sister and give her name. Which sentence fits?",options=["ሓፍተይ ስማ ማርያም እዩ።","ኣብ ገዛ ኣለኹ።","ማይ እሰቲ።","ሎሚ ሰኑይ እዩ።"],correct="ሓፍተይ ስማ ማርያም እዩ።"),
    AssessmentQuestion(id="ti-a1-004",skill="speaking",difficulty="A1",question="You describe your daily routine. Which sentence says that you go to school every day?",options=["ኩሉ መዓልቲ ናብ ቤት ትምህርቲ እኸይድ።","ኣብ ገዛ ኣለኹ።","ሰላም፣ ከመይ ኣለኻ?","የቐንየለይ ንሓገዝካ።"],correct="ኩሉ መዓልቲ ናብ ቤት ትምህርቲ እኸይድ።"),
    AssessmentQuestion(id="ti-a1-005",skill="vocabulary",difficulty="A1",question="You say that today is Monday. Which Tigrinya sentence should you choose?",options=["ሎሚ ሰኑይ እዩ።","ስመይ ሚካኤል እዩ።","ማይ እሰቲ።","ኣብ ገዛ ኣለኹ።"],correct="ሎሚ ሰኑይ እዩ።"),
    AssessmentQuestion(id="ti-a1-006",skill="communication",difficulty="A1",question="You are thirsty and talk about drinking water. Which sentence fits?",options=["ማይ እሰቲ።","ሎሚ ሰኑይ እዩ።","ስመይ ሚካኤል እዩ።","ኣብ ገዛ ኣለኹ።"],correct="ማይ እሰቲ።"),
    AssessmentQuestion(id="ti-a1-007",skill="vocabulary",difficulty="A1",question="You tell someone where you are. Which sentence says you are at home?",options=["ኣብ ገዛ ኣለኹ።","ኩሉ መዓልቲ ናብ ቤት ትምህርቲ እኸይድ።","ማይ እሰቲ።","ሰላም፣ ከመይ ኣለኻ?"],correct="ኣብ ገዛ ኣለኹ።"),
    AssessmentQuestion(id="ti-a1-008",skill="communication",difficulty="A1",question="Someone helped you. Which Tigrinya phrase thanks them for the help?",options=["የቐንየለይ ንሓገዝካ።","ሎሚ ሰኑይ እዩ።","ስመይ ሚካኤል እዩ።","ማይ እሰቲ።"],correct="የቐንየለይ ንሓገዝካ።"),
    AssessmentQuestion(id="ti-a1-009",skill="reading",difficulty="A1",question="Which phrase would you use to open a simple conversation?",options=["ሰላም፣ ከመይ ኣለኻ?","ማይ እሰቲ።","ሎሚ ሰኑይ እዩ።","ኣብ ገዛ ኣለኹ።"],correct="ሰላም፣ ከመይ ኣለኻ?"),
    AssessmentQuestion(id="ti-a1-010",skill="production",difficulty="A1",question="Which phrase is appropriate when thanking someone for help?",options=["የቐንየለይ ንሓገዝካ።","ስመይ ሚካኤል እዩ።","ሎሚ ሰኑይ እዩ።","ኩሉ መዓልቲ ናብ ቤት ትምህርቲ እኸይድ።"],correct="የቐንየለይ ንሓገዝካ።"),
]