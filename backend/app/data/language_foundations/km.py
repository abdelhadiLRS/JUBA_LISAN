...
("greetings_a1","Greetings",[("សួស្តី!","greeting"),("ខ្ញុំឈ្មោះសុភា។","introducing yourself"),("អ្នកឈ្មោះអ្វី?","asking someone’s name"),("រីករាយដែលបានស្គាល់អ្នក។","meeting someone")]),
("shopping_a1","Shopping",[("តម្លៃប៉ុន្មាន?","asking price"),("ខ្ញុំចង់បានមួយ។","requesting an item"),("ខ្ញុំចង់បានទឹកមួយដប។","asking for a bottle of water"),("មានមួយទៀតទេ?","asking for another option")]),
