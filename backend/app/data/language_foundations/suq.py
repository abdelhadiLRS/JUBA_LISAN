...
ASSESSMENT_BANK=[
    AssessmentQuestion(id="suq-a1-001",skill="speaking",difficulty="A1",question="Which expression matches the lesson meaning 'hello'?",options=["Supa","technical term","advanced idiom","unrelated expression"],correct="Supa"),
    AssessmentQuestion(id="suq-a1-002",skill="vocabulary",difficulty="A1",question="Which expression matches the lesson meaning 'my name is...'?",options=["Nanyor...","technical term","advanced idiom","unrelated expression"],correct="Nanyor..."),
    AssessmentQuestion(id="suq-a1-003",skill="grammar",difficulty="A1",question="Which expression matches the lesson meaning 'house/home'?",options=["enkaji","technical term","advanced idiom","unrelated expression"],correct="enkaji"),
    AssessmentQuestion(id="suq-a1-004",skill="speaking",difficulty="A1",question="Which expression matches the lesson meaning 'work'?",options=["aisho","technical term","advanced idiom","unrelated expression"],correct="aisho"),
    AssessmentQuestion(id="suq-a1-005",skill="vocabulary",difficulty="A1",question="Which expression matches the lesson meaning 'today'?",options=["aitidua","technical term","advanced idiom","unrelated expression"],correct="aitidua"),
    AssessmentQuestion(id="suq-a1-006",skill="grammar",difficulty="A1",question="Which expression matches the lesson meaning 'water'?",options=["enkare","technical term","advanced idiom","unrelated expression"],correct="enkare"),
    AssessmentQuestion(id="suq-a1-007",skill="speaking",difficulty="A1",question="Which expression matches the lesson meaning 'home'?",options=["enkaji","technical term","advanced idiom","unrelated expression"],correct="enkaji"),
    AssessmentQuestion(id="suq-a1-008",skill="vocabulary",difficulty="A1",question="Which expression matches the lesson meaning 'thank you'?",options=["ashe","technical term","advanced idiom","unrelated expression"],correct="ashe"),
    AssessmentQuestion(id="suq-a1-009",skill="reading",difficulty="A1",question="Select the everyday A1 expression.",options=["Supa","advanced academic phrase","technical formula","rare literary term"],correct="Supa"),
    AssessmentQuestion(id="suq-a1-010",skill="production",difficulty="A1",question="Select the polite expression for closing an everyday exchange.",options=["ashe","technical term","advanced idiom","unrelated expression"],correct="ashe"),
]
