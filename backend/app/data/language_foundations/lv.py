...
VOCABULARY_SETS=[
_v("lv_a1_greetings","A1","greetings","lv-a1-unit-1",[("sveiki","phrase","hello","Sveiki! Kā jums klājas?"),("labdien","phrase","good afternoon/hello","Labdien, kundze."),("paldies","phrase","thank you","Paldies par palīdzību."),("lūdzu","phrase","please/you are welcome","Lūdzu, apsēdieties."),("uz redzēšanos","phrase","goodbye","Uz redzēšanos, līdz rītdienai.")]),
...
_v("lv_a2_time","A2","time and plans","lv-a2-unit-1",[("pagājušajā nedēļā","phrase","last week","Pagājušajā nedēļā biju Cēsīs."),("nākamajā mēnesī","phrase","next month","Nākamajā mēnesī ceļosim."),("bieži","adverb","often","Es bieži braucu ar autobusu."),("dažreiz","adverb","sometimes","Dažreiz strādāju no mājām."),("vēlāk","adverb","later","Tiksimies vēlāk.")]),
...
_v("lv_b2_media","B2","media","lv-b2-unit-2",[("avots","noun","source","Pārbaudiet informācijas avotu."),("ziņojums","noun","report/announcement","Izlasīju oficiālo ziņojumu."),("sabiedrības viedoklis","phrase","public opinion","Sabiedrības viedoklis mainījās."),("neobjektivitāte","noun","bias","Rakstā redzama neobjektivitāte."),("uzticams","adjective","reliable","Tas ir uzticams avots.")]),
...
_v("lv_c1_professional","C1","professional","lv-c1-unit-2",[("īstenot","verb","to implement","Plāns jāīsteno pa posmiem."),("sadarboties","verb","to cooperate","Uzņēmumi sāka sadarboties."),("prioritāte","noun","priority","Drošība ir galvenā prioritāte."),("efektivitāte","noun","effectiveness","Mēs novērtējām pasākuma efektivitāti."),("ņemt vērā","phrase","to take into account","Jāņem vērā visi apstākļi.")]),
...
_v("lv_c2_formal","C2","formal style","lv-c2-unit-2",[("ņemot vērā","phrase","in view of","Ņemot vērā apstākļus, lēmums tiek atlikts."),("jāuzsver","phrase","it should be emphasized","Jāuzsver, ka dati nav galīgi."),("var uzskatīt","phrase","it may be considered","Var uzskatīt, ka pasākums būs efektīvs."),("neskatoties uz","preposition","despite","Neskatoties uz grūtībām, projekts turpinās."),("attiecīgi","adverb","accordingly","Rezultāti attiecīgi tika koriģēti.")]),
]
...
PhrasebookCategory(id="lv_b1_work",level="B1",situation="work",icon="💼",phrases=[PhrasebookEntry(text="Vai varam apspriest šo jautājumu?",context="work discussion",register="formal"),PhrasebookEntry(text="Ierosinu tikties nākamnedēļ.",context="making a proposal",register="formal"),PhrasebookEntry(text="Atbildi sniegšu līdz piektdienai.",context="setting a deadline",register="formal")]),
...
PhrasebookCategory(id="lv_c1_academic",level="C1",situation="academic",icon="🎓",phrases=[PhrasebookEntry(text="Pētījuma rezultāti liecina, ka...",context="presenting findings",register="formal"),PhrasebookEntry(text="Šis pieņēmums prasa papildu pamatojumu.",context="academic critique",register="formal"),PhrasebookEntry(text="Apkopojot var secināt, ka...",context="conclusion",register="formal")]),
...
AssessmentQuestion(id="lv-a1-002",skill="communication",difficulty="A1",question="Which sentence means 'I am a student'?",options=["Es esmu students.","Es dzīvoju Rīgā.","Man ir brālis.","Es strādāju mājās."],correct="Es esmu students."),
...
AssessmentQuestion(id="lv-a2-002",skill="communication",difficulty="A2",question="How do you ask when the bus leaves?",options=["Kad atiet autobuss?","Kur tu dzīvo?","Cik tas maksā?","Kā tev klājas?"],correct="Kad atiet autobuss?"),
...
AssessmentQuestion(id="lv-b1-002",skill="discourse",difficulty="B1",question="Which word means 'conclusion'?",options=["secinājums","pieņēmums","sekas","atbildība"],correct="secinājums"),
...
AssessmentQuestion(id="lv-c2-002",skill="pragmatics",difficulty="C2",question="Which word describes a subtle stylistic difference?",options=["smalks","skaļš","ikdienas","ātrs"],correct="smalks"),
]
