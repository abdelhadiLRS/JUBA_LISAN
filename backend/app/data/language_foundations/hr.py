...
VOCABULARY_SETS=[
VocabularySet(id="greetings_a1",level="A1",topic="greetings",unit_ref="hr-a1-unit-1",words=[VocabularyEntry(word="Bok",pos="word",definition="hi",example="Bok! Kako si?"),VocabularyEntry(word="dobro jutro",pos="phrase",definition="good morning",example="Dobro jutro!"),VocabularyEntry(word="hvala",pos="word",definition="thank you",example="Hvala na pomoći."),VocabularyEntry(word="doviđenja",pos="word",definition="goodbye",example="Doviđenja i ugodan dan.")]),
VocabularySet(id="identity_a1",level="A1",topic="identity",unit_ref="hr-a1-unit-2",words=[VocabularyEntry(word="ime",pos="word",definition="name",example="Kako ti je ime?"),VocabularyEntry(word="učenik",pos="word",definition="student",example="Ja sam učenik."),VocabularyEntry(word="prijatelj",pos="word",definition="friend",example="On je moj prijatelj."),VocabularyEntry(word="jezik",pos="word",definition="language",example="Hrvatski je moj ciljni jezik.")]),
VocabularySet(id="family_a1",level="A1",topic="family",unit_ref="hr-a1-unit-3",words=[VocabularyEntry(word="majka",pos="word",definition="mother",example="Moja majka radi."),VocabularyEntry(word="otac",pos="word",definition="father",example="Moj otac je kod kuće."),VocabularyEntry(word="brat",pos="word",definition="brother",example="Moj brat studira."),VocabularyEntry(word="sestra",pos="word",definition="sister",example="Moja sestra čita.")]),
VocabularySet(id="home_a1",level="A1",topic="home",unit_ref="hr-a1-unit-4",words=[VocabularyEntry(word="kuća",pos="word",definition="house",example="Moja kuća je velika."),VocabularyEntry(word="soba",pos="word",definition="room",example="Soba je svijetla."),VocabularyEntry(word="vrata",pos="word",definition="door",example="Vrata su otvorena."),VocabularyEntry(word="stol",pos="word",definition="table",example="Knjiga je na stolu.")]),
VocabularySet(id="daily_a1",level="A1",topic="daily",unit_ref="hr-a1-unit-5",words=[VocabularyEntry(word="jutro",pos="word",definition="morning",example="Ujutro pijem kavu."),VocabularyEntry(word="posao",pos="word",definition="work",example="Idem na posao."),VocabularyEntry(word="voda",pos="word",definition="water",example="Pijem vodu."),VocabularyEntry(word="danas",pos="word",definition="today",example="Danas učim hrvatski.")]),
VocabularySet(id="food_a1",level="A1",topic="food",unit_ref="hr-a1-unit-6",words=[VocabularyEntry(word="kruh",pos="word",definition="bread",example="Kupujem kruh."),VocabularyEntry(word="kava",pos="word",definition="coffee",example="Želim kavu."),VocabularyEntry(word="jabuka",pos="word",definition="apple",example="Jedem jabuku."),VocabularyEntry(word="račun",pos="word",definition="bill",example="Molim račun.")]),
VocabularySet(id="places_a1",level="A1",topic="places",unit_ref="hr-a1-unit-7",words=[VocabularyEntry(word="škola",pos="word",definition="school",example="Škola je blizu."),VocabularyEntry(word="tržnica",pos="word",definition="market",example="Gdje je tržnica?"),VocabularyEntry(word="bolnica",pos="word",definition="hospital",example="Bolnica je u centru."),VocabularyEntry(word="ulica",pos="word",definition="street",example="Živim u ovoj ulici.")]),
VocabularySet(id="communication_a1",level="A1",topic="communication",unit_ref="hr-a1-unit-8",words=[VocabularyEntry(word="pitanje",pos="word",definition="question",example="Imam jedno pitanje."),VocabularyEntry(word="pomoć",pos="word",definition="help",example="Trebam pomoć."),VocabularyEntry(word="razgovor",pos="word",definition="conversation",example="Imamo kratak razgovor."),VocabularyEntry(word="razumjeti",pos="verb",definition="to understand",example="Ne razumijem pitanje.")]),
VocabularySet(id="past_a2",level="A2",topic="past experiences",unit_ref="hr-a2-unit-2",words=[VocabularyEntry(word="jučer",pos="adverb",definition="yesterday",example="Jučer sam radio."),VocabularyEntry(word="putovati",pos="verb",definition="to travel",example="Putovali smo prošlog ljeta."),VocabularyEntry(word="stići",pos="verb",definition="to arrive",example="Stigli smo na vrijeme."),VocabularyEntry(word="posjetiti",pos="verb",definition="to visit",example="Posjetila je Zagreb.")]),
VocabularySet(id="travel_a2",level="A2",topic="travel",unit_ref="hr-a2-unit-4",words=[VocabularyEntry(word="kolodvor",pos="word",definition="station",example="Kolodvor je blizu."),VocabularyEntry(word="karta",pos="word",definition="ticket",example="Trebam povratnu kartu."),VocabularyEntry(word="smještaj",pos="word",definition="accommodation",example="Rezervirali smo smještaj."),VocabularyEntry(word="putovanje",pos="word",definition="journey",example="Putovanje traje tri sata.")]),
VocabularySet(id="work_b1",level="B1",topic="work",unit_ref="hr-b1-unit-2",words=[VocabularyEntry(word="sastanak",pos="word",definition="meeting",example="Sastanak počinje u devet."),VocabularyEntry(word="rok",pos="word",definition="deadline",example="Rok je u petak."),VocabularyEntry(word="iskustvo",pos="word",definition="experience",example="Imam iskustvo u prodaji."),VocabularyEntry(word="vještina",pos="word",definition="skill",example="Komunikacijske vještine su važne.")]),
VocabularySet(id="media_b1",level="B1",topic="media",unit_ref="hr-b1-unit-4",words=[VocabularyEntry(word="vijest",pos="word",definition="news item",example="Pročitao sam vijest."),VocabularyEntry(word="izvor",pos="word",definition="source",example="Provjeri izvor informacije."),VocabularyEntry(word="stav",pos="word",definition="viewpoint",example="Izrazio je svoj stav."),VocabularyEntry(word="rasprava",pos="word",definition="discussion",example="Rasprava je bila zanimljiva.")]),
VocabularySet(id="society_b2",level="B2",topic="society",unit_ref="hr-b2-unit-3",words=[VocabularyEntry(word="društvo",pos="word",definition="society",example="Društvo se brzo mijenja."),VocabularyEntry(word="održivost",pos="word",definition="sustainability",example="Održivost je važan cilj."),VocabularyEntry(word="posljedica",pos="word",definition="consequence",example="Moramo procijeniti posljedice."),VocabularyEntry(word="rješenje",pos="word",definition="solution",example="Predloženo je novo rješenje.")]),
VocabularySet(id="argumentation_b2",level="B2",topic="argumentation",unit_ref="hr-b2-unit-5",words=[VocabularyEntry(word="međutim",pos="adverb",definition="however",example="Međutim, postoje i drugačiji podaci."),VocabularyEntry(word="stoga",pos="adverb",definition="therefore",example="Stoga predlažemo promjenu."),VocabularyEntry(word="dokaz",pos="word",definition="evidence",example="Dokaz podupire tvrdnju."),VocabularyEntry(word="pretpostavka",pos="word",definition="assumption",example="Ta pretpostavka nije potvrđena.")]),
VocabularySet(id="professional_c1",level="C1",topic="professional communication",unit_ref="hr-c1-unit-2",words=[VocabularyEntry(word="dostaviti",pos="verb",definition="to submit/provide",example="Molimo vas da dostavite dokumentaciju."),VocabularyEntry(word="provedba",pos="word",definition="implementation",example="Provedba mjere počinje u lipnju."),VocabularyEntry(word="zahtjev",pos="word",definition="request/application",example="Zahtjev je zaprimljen."),VocabularyEntry(word="nadležnost",pos="word",definition="jurisdiction/responsibility",example="To je u nadležnosti odjela.")]),
VocabularySet(id="academic_c1",level="C1",topic="academic language",unit_ref="hr-c1-unit-4",words=[VocabularyEntry(word="istraživanje",pos="word",definition="research",example="Istraživanje pokazuje trend."),VocabularyEntry(word="metodologija",pos="word",definition="methodology",example="Metodologija je jasno opisana."),VocabularyEntry(word="nalaz",pos="word",definition="finding",example="Nalazi potvrđuju hipotezu."),VocabularyEntry(word="ograničenje",pos="word",definition="limitation",example="Istraživanje ima nekoliko ograničenja.")]),
VocabularySet(id="nuance_c2",level="C2",topic="nuance and style",unit_ref="hr-c2-unit-2",words=[VocabularyEntry(word="dvosmislen",pos="adjective",definition="ambiguous",example="Izjava je namjerno dvosmislena."),VocabularyEntry(word="nijansa",pos="word",definition="nuance",example="Važna je semantička nijansa."),VocabularyEntry(word="pretpostaviti",pos="verb",definition="to assume",example="Ne možemo unaprijed pretpostaviti ishod."),VocabularyEntry(word="ublažiti",pos="verb",definition="to mitigate/soften",example="Autor nastoji ublažiti tvrdnju.")]),
VocabularySet(id="idioms_c2",level="C2",topic="idioms",unit_ref="hr-c2-unit-5",words=[VocabularyEntry(word="držati figu u džepu",pos="idiom",definition="to secretly have a different intention",example="Čini se da drži figu u džepu."),VocabularyEntry(word="baciti oko",pos="idiom",definition="to take a look",example="Baci oko na ovaj prijedlog."),VocabularyEntry(word="nije sve crno-bijelo",pos="expression",definition="things are not simply one-sided",example="Situacija je složena; nije sve crno-bijelo.")])
]
...
"A2":["past_a2","travel_a2","travel_a2","past_a2","identity_a1","daily_a1","places_a1","communication_a1"],
"B1":["work_b1","media_b1","work_b1","media_b1","argumentation_b2","society_b2","work_b1","media_b1"],
"B2":["society_b2","argumentation_b2","society_b2","media_b1","argumentation_b2","professional_c1","society_b2","argumentation_b2"],
"C1":["professional_c1","academic_c1","professional_c1","academic_c1","academic_c1","professional_c1","academic_c1","professional_c1"],
...
AssessmentQuestion(id="hr-c2-001",skill="style",difficulty="C2",question="Which expression explicitly signals semantic nuance?",options=["nijansa","vrata","kolodvor","kruh"],correct="nijansa"),
