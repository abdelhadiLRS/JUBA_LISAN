...
AssessmentQuestion(id="st-b2-002",skill="formal",difficulty="B2",question="Which phrase fits a formal request?",options=["Re le kopa hore le re romelle...","Lumela.","Ke batla sena.","U hokae?"],correct="Re le kopa hore le re romelle..."),
...
AssessmentQuestion(id="st-c1-002",skill="formal",difficulty="C1",question="Which sentence is a formal institutional request?",options=["Re le kopa hore le re romelle litokomane tse hlokahalang.","Ke lapeng.","Ke batla metsi.","U hokae?"],correct="Re le kopa hore le re romelle litokomane tse hlokahalang."),
