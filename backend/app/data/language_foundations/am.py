...
PhrasebookCategory(id="am-work",level="B1",situation="Work",icon="💼",phrases=[PhrasebookEntry(text="ስብሰባውን እንጀምር።",context="Let's start the meeting.",register="professional"),PhrasebookEntry(text="እባክዎ ማስረጃውን ያቅርቡ።",context="Please provide the evidence.",register="professional"),PhrasebookEntry(text="በዚህ ጉዳይ እንስማማለን።",context="We agree on this matter.",register="professional")]),
...
PhrasebookCategory(id="am-academic",level="C1",situation="Academic writing",icon="📚",phrases=[PhrasebookEntry(text="ይህ ጥናት ያሳያል...",context="This study shows...",register="academic"),PhrasebookEntry(text="ይህ ሊያመለክት ይችላል...",context="This may indicate...",register="academic"),PhrasebookEntry(text="ተጨማሪ ምርምር ያስፈልጋል።",context="Further research is needed.",register="academic")]),
...
AssessmentQuestion(id="am-a1-004",skill="shopping",difficulty="A1",question="How do you ask ‘How much is this?’",options=["ይህ ስንት ነው?","የት ነው?","እንዴት ነህ?","በዝግታ ይናገሩ።"],correct="ይህ ስንት ነው?"),
