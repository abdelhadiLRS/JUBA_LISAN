...
_UNITS = {
"A1":[("Introductions","identity-pronouns","Greetings"),("People and family","basic-word-order","Family"),("Home and routine","present-tense","Home"),("Time and schedules","negation","Daily life"),("Food and shopping","questions","Shopping"),("Town and directions","possessives","Places"),("Transport and services","plural-nouns","Transport"),("Everyday review","questions","Everyday communication")],
