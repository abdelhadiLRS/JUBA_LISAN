...
ASSESSMENT_BANK = [
    ...
    AssessmentQuestion(id="rw-b2-002",skill="formal",difficulty="B2",question="Which phrase is appropriate for a formal request?",options=["Turabasaba ko mwatwoherereza...","Mpa ibi.","Muraho.","Amakuru?"],"correct":"Turabasaba ko mwatwoherereza..."),
    ...
    AssessmentQuestion(id="rw-c1-002",skill="formal",difficulty="C1",question="Which sentence is a formal institutional request?",options=["Turabasaba ko mwatwoherereza inyandiko zikenewe.","Ndi mu rugo.","Ndashaka amazi.","Amakuru?"],"correct":"Turabasaba ko mwatwoherereza inyandiko zikenewe."),
