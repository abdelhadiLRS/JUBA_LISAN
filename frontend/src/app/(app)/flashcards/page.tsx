...
const btnPrimary =
  'inline-flex items-center justify-center gap-2 rounded-[20px] border-2 border-[#39751d] px-4 py-2.5 text-sm font-semibold text-white transition-colors disabled:opacity-50'
const btnSecondary =
  'inline-flex items-center justify-center gap-2 rounded-[20px] border border-[#e2f2d3] px-4 py-2.5 text-sm font-medium transition-colors hover:bg-[#e2f2d3]'
...
export default function FlashcardsPage() {
  ...
  return (
    <div className="juba-mobile-flashcards mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6 md:py-8">
      ...
      <div className="rounded-[30px] border-2 border-[#e2f2d3] bg-white p-5 shadow-[3px_3px_0_var(--juba-border)] sm:p-6"><div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`${btnPrimary} ${showGenerate ? 'bg-[#39751d]' : 'bg-[#39751d] hover:bg-[#39751d]'}`}
          >
          ...
          <form onSubmit={generateCards} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="bg-[#e2f2d3]/40 border-[#e2f2d3] text-[var(--juba-text)] placeholder:text-[var(--juba-muted)] focus:border-[#39751d] w-full rounded-[20px] border px-4 py-3 text-sm transition-colors focus:outline-none"
              />
            </div>
            ...
            <button
              ...
              className={`${btnPrimary} w-full bg-[#39751d] hover:bg-[#39751d]`}
            >
              {generating ? (
                <>
                  <Layers
      ...
      {/* No cards */}
      {cards.length === 0 && (
        <div className="border-[#e2f2d3] bg-white rounded-[28px] border px-6 py-12 text-center">
          <span
        ...
        <>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              {/* Mode toggle */}
              <div className="bg-[#e2f2d3]/60 inline-flex rounded-[20px] p-1">
                <button
                  onClick={() => {
            ...
            <div className="bg-[#e2f2d3]/60 h-1.5 overflow-hidden rounded-full">
              <div
          ...
          {!speakingMode && (
            <>
              <div
                className="juba-card cursor-pointer select-none overflow-hidden border-2 border-[#e2f2d3] shadow-[0_24px_60px_rgba(61,42,130,0.12)]"
              ...
              >
                <div className="border-[#e2f2d3] flex items-center justify-between border-b px-6 py-3.5">
                  ...
                  {!flipped ? (
                    ...
                    <>
                      ...
                      {cards[current].translation && (
                        <p className="text-[var(--juba-muted)] border-[#e2f2d3] mt-1 border-t pt-3 text-sm">
                          {cards[current].translation}
                        </p>
                      )}
                    </>
                  ...
                  {[
                    ...
                    { key: 'good', q: 4, style: { color: 'var(--juba-text)' } },
                    {
                      ...
                      style: {
                        color: '#39751d',
                        borderColor:
                          'color-mix(in srgb, #39751d 45%, #e2f2d3)',
                      },
                    },
                  ].map(({ key, q, style }) => (
                    <button
