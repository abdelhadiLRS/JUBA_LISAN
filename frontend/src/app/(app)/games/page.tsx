...
const copy = {\nconst copy = {
  ar: {
    ...
    listenChoose: 'استمع واختر', listeningDetective: 'محقق الاستماع', spelling: 'تحدي الإملاء', memory: 'بطاقات الذاكرة',
    ...
    sentenceBuilderDesc: 'رتّب الكلمات لبناء جملة صحيحة.', listenChooseDesc: 'استمع إلى الكلمة ثم اخترها.', listeningDetectiveDesc: 'استمع إلى جملة والتقط المعلومة الأساسية.',
...
lang: 'اللغة', xp: 'XP', skills: 'المهارات', stats: 'إحصائياتك', gamesPlayed: 'الألعاب',
  ...
  fr: {
    ...
    listenChoose: 'Écoute et choisis', listeningDetective: 'Détective de l’écoute', spelling: 'Défi d’orthographe', memory: 'Cartes mémoire',
    ...
    sentenceBuilderDesc: 'Remets les mots dans le bon ordre.', listenChooseDesc: 'Écoute le mot puis choisis-le.', listeningDetectiveDesc: 'Écoute une phrase et repère le détail clé.',
  ...
  \nen: {
    ...
    listenChoose: 'Listen & Choose', listeningDetective: 'Listening Detective', spelling: 'Spelling Challenge', memory: 'Memory Cards',
    ...
    sentenceBuilderDesc: 'Arrange the words to build a correct sentence.', listenChooseDesc: 'Listen to the word and choose it.', listeningDetectiveDesc: 'Listen to a sentence and identify the key detail.',
...
,\n  es: {"title":"JUBA LISAN","subtitle":"Aprende jugando. Mejora cada día.","points":"Puntos","streak":"Racha","level":"Nivel","games":"Juegos educativos","daily":"Desafío diario","dailyDesc":"Un desafío fijo cada día. Complétalo para ganar XP y crear tu hábito.","wordMatch":"Parejas de palabras","quickChoice":"Elección rápida","contextQuest":"Misión de contexto","sentenceBuilder":"Constructor de frases","listenChoose":"Escucha y elige","listeningDetective":"Detective de escucha","spelling":"Desafío de ortografía","memory":"Cartas de memoria","wordMatchDesc":"Relaciona cada palabra con su traducción correcta.","quickChoiceDesc":"Elige antes de que termine el tiempo.","contextQuestDesc":"Elige la respuesta natural para la situación.","sentenceBuilderDesc":"Ordena las palabras para formar una frase correcta.","listenChooseDesc":"Escucha la palabra y elígela.","listeningDetectiveDesc":"Escucha una frase e identifica el detalle clave.","spellingDesc":"Escribe la palabra indicada por la pista.","wordScramble":"Letras mezcladas","fillBlank":"Completa el espacio","wordScrambleDesc":"Ordena las letras para recuperar la palabra.","fillBlankDesc":"Elige la palabra que completa la frase.","memoryDesc":"Descubre las cartas y forma parejas.","start":"Empezar","next":"Siguiente pregunta","correct":"¡Correcto!","wrong":"No exactamente","hint":"Pista","back":"Juegos","score":"Puntuación de la ronda","done":"¡Muy bien! Ronda completada.","choose":"Elige la respuesta correcta","lang":"Idioma","xp":"XP","skills":"Habilidades","stats":"Tus estadísticas","gamesPlayed":"Partidas","questions":"Preguntas","accuracy":"Precisión","best":"Mejor puntuación","badges":"Logros","unlocked":"desbloqueado","newBadge":"¡Nuevo logro!","answered":"Respuesta registrada."},\n  de: {"title":"JUBA LISAN","subtitle":"Lerne spielerisch. Werde jeden Tag besser.","points":"Punkte","streak":"Serie","level":"Level","games":"Lernspiele","daily":"Tageschallenge","dailyDesc":"Eine feste Challenge pro Tag. Schließe sie ab, um XP zu verdienen.","wordMatch":"Wortpaare","quickChoice":"Schnellauswahl","contextQuest":"Kontext-Mission","sentenceBuilder":"Satzbau","listenChoose":"Hören & Wählen","listeningDetective":"Hördetektiv","spelling":"Rechtschreib-Challenge","memory":"Memory-Karten","wordMatchDesc":"Ordne jedes Wort seiner richtigen Übersetzung zu.","quickChoiceDesc":"Wähle, bevor die Zeit abläuft.","contextQuestDesc":"Wähle die natürliche Antwort für die Situation.","sentenceBuilderDesc":"Ordne die Wörter zu einem korrekten Satz.","listenChooseDesc":"Höre das Wort und wähle es aus.","listeningDetectiveDesc":"Höre einen Satz und finde das wichtige Detail.","spellingDesc":"Schreibe das gesuchte Wort anhand des Hinweises.","wordScramble":"Buchstabensalat","fillBlank":"Lückentext","wordScrambleDesc":"Ordne die Buchstaben zum richtigen Wort.","fillBlankDesc":"Wähle das Wort, das den Satz ergänzt.","memoryDesc":"Decke Karten auf und finde die Paare.","start":"Spiel starten","next":"Nächste Frage","correct":"Richtig!","wrong":"Noch nicht","hint":"Hinweis","back":"Spiele","score":"Rundenpunktzahl","done":"Gut gemacht! Runde beendet.","choose":"Wähle die richtige Antwort","lang":"Sprache","xp":"XP","skills":"Fähigkeiten","stats":"Deine Statistik","gamesPlayed":"Spiele","questions":"Fragen","accuracy":"Genauigkeit","best":"Beste Punktzahl","badges":"Erfolge","unlocked":"freigeschaltet","newBadge":"Neuer Erfolg!","answered":"Antwort gespeichert."},\n  it: {"title":"JUBA LISAN","subtitle":"Impara giocando. Migliora ogni giorno.","points":"Punti","streak":"Serie","level":"Livello","games":"Giochi educativi","daily":"Sfida del giorno","dailyDesc":"Una sfida fissa ogni giorno per guadagnare XP.","wordMatch":"Abbinamento parole","quickChoice":"Scelta rapida","contextQuest":"Missione di contesto","sentenceBuilder":"Costruttore di frasi","listenChoose":"Ascolta e scegli","listeningDetective":"Detective dell’ascolto","spelling":"Sfida di ortografia","memory":"Carte memoria","wordMatchDesc":"Abbina ogni parola alla traduzione corretta.","quickChoiceDesc":"Scegli prima che finisca il tempo.","contextQuestDesc":"Scegli la risposta naturale per la situazione.","sentenceBuilderDesc":"Metti le parole nell’ordine corretto.","listenChooseDesc":"Ascolta la parola e sceglila.","listeningDetectiveDesc":"Ascolta una frase e individua il dettaglio chiave.","spellingDesc":"Scrivi la parola richiesta dall’indizio.","wordScramble":"Lettere mescolate","fillBlank":"Completa lo spazio","wordScrambleDesc":"Riordina le lettere per trovare la parola.","fillBlankDesc":"Scegli la parola che completa la frase.","memoryDesc":"Scopri le carte e abbina le coppie.","start":"Inizia","next":"Domanda successiva","correct":"Corretto!","wrong":"Non proprio","hint":"Suggerimento","back":"Giochi","score":"Punteggio del round","done":"Ottimo! Round completato.","choose":"Scegli la risposta corretta","lang":"Lingua","xp":"XP","skills":"Abilità","stats":"Le tue statistiche","gamesPlayed":"Partite","questions":"Domande","accuracy":"Precisione","best":"Miglior punteggio","badges":"Obiettivi","unlocked":"sbloccato","newBadge":"Nuovo obiettivo!","answered":"Risposta registrata."},\n  pt: {"title":"JUBA LISAN","subtitle":"Aprenda jogando. Melhore todos os dias.","points":"Pontos","streak":"Sequência","level":"Nível","games":"Jogos educativos","daily":"Desafio diário","dailyDesc":"Um desafio fixo por dia para ganhar XP.","wordMatch":"Combinação de palavras","quickChoice":"Escolha rápida","contextQuest":"Missão de contexto","sentenceBuilder":"Construtor de frases","listenChoose":"Ouça e escolha","listeningDetective":"Detetive de escuta","spelling":"Desafio de ortografia","memory":"Cartas de memória","wordMatchDesc":"Associe cada palavra à tradução correta.","quickChoiceDesc":"Escolha antes de o tempo acabar.","contextQuestDesc":"Escolha a resposta natural para a situação.","sentenceBuilderDesc":"Organize as palavras para formar uma frase correta.","listenChooseDesc":"Ouça a palavra e escolha-a.","listeningDetectiveDesc":"Ouça uma frase e identifique o detalhe principal.","spellingDesc":"Escreva a palavra indicada pela pista.","wordScramble":"Letras embaralhadas","fillBlank":"Complete o espaço","wordScrambleDesc":"Organize as letras para recuperar a palavra.","fillBlankDesc":"Escolha a palavra que completa a frase.","memoryDesc":"Revele as cartas e encontre os pares.","start":"Começar","next":"Próxima pergunta","correct":"Correto!","wrong":"Ainda não","hint":"Dica","back":"Jogos","score":"Pontuação da rodada","done":"Muito bem! Rodada concluída.","choose":"Escolha a resposta correta","lang":"Idioma","xp":"XP","skills":"Competências","stats":"As suas estatísticas","gamesPlayed":"Jogos","questions":"Perguntas","accuracy":"Precisão","best":"Melhor pontuação","badges":"Conquistas","unlocked":"desbloqueado","newBadge":"Nova conquista!","answered":"Resposta registada."},\n  pl: {"title":"JUBA LISAN","subtitle":"Ucz się przez zabawę. Rób postępy każdego dnia.","points":"Punkty","streak":"Seria","level":"Poziom","games":"Gry edukacyjne","daily":"Wyzwanie dnia","dailyDesc":"Jedno wyzwanie dziennie, aby zdobywać XP i budować nawyk.","wordMatch":"Dopasowanie słów","quickChoice":"Szybki wybór","contextQuest":"Misja kontekstowa","sentenceBuilder":"Budowanie zdań","listenChoose":"Słuchaj i wybierz","listeningDetective":"Detektyw słuchania","spelling":"Wyzwanie ortograficzne","memory":"Karty pamięci","wordMatchDesc":"Dopasuj każde słowo do właściwego tłumaczenia.","quickChoiceDesc":"Wybierz, zanim skończy się czas.","contextQuestDesc":"Wybierz naturalną odpowiedź do sytuacji.","sentenceBuilderDesc":"Ułóż słowa w poprawne zdanie.","listenChooseDesc":"Posłuchaj słowa i wybierz je.","listeningDetectiveDesc":"Posłuchaj zdania i znajdź kluczową informację.","spellingDesc":"Wpisz słowo na podstawie wskazówki.","wordScramble":"Pomieszane litery","fillBlank":"Uzupełnij lukę","wordScrambleDesc":"Ułóż litery, aby odtworzyć słowo.","fillBlankDesc":"Wybierz słowo uzupełniające zdanie.","memoryDesc":"Odkrywaj karty i łącz pary.","start":"Rozpocznij","next":"Następne pytanie","correct":"Dobrze!","wrong":"Jeszcze nie","hint":"Wskazówka","back":"Gry","score":"Wynik rundy","done":"Świetnie! Runda ukończona.","choose":"Wybierz poprawną odpowiedź","lang":"Język","xp":"XP","skills":"Umiejętności","stats":"Twoje statystyki","gamesPlayed":"Gry","questions":"Pytania","accuracy":"Dokładność","best":"Najlepszy wynik","badges":"Osiągnięcia","unlocked":"odblokowane","newBadge":"Nowe osiągnięcie!","answered":"Odpowiedź zapisana."},\n  nl: {"title":"JUBA LISAN","subtitle":"Leer door te spelen. Word elke dag beter.","points":"Punten","streak":"Reeks","level":"Niveau","games":"Educatieve spellen","daily":"Dagelijkse uitdaging","dailyDesc":"Elke dag één uitdaging om XP te verdienen en een leergewoonte op te bouwen.","wordMatch":"Woordkoppeling","quickChoice":"Snelle keuze","contextQuest":"Contextmissie","sentenceBuilder":"Zinnen bouwen","listenChoose":"Luister & kies","listeningDetective":"Luisterdetective","spelling":"Spellinguitdaging","memory":"Geheugenkaarten","wordMatchDesc":"Koppel elk woord aan de juiste vertaling.","quickChoiceDesc":"Kies voordat de tijd om is.","contextQuestDesc":"Kies de natuurlijke reactie voor de situatie.","sentenceBuilderDesc":"Zet de woorden in de juiste volgorde.","listenChooseDesc":"Luister naar het woord en kies het.","listeningDetectiveDesc":"Luister naar een zin en vind het belangrijkste detail.","spellingDesc":"Typ het gevraagde woord op basis van de hint.","wordScramble":"Woordpuzzel","fillBlank":"Vul de lege plek","wordScrambleDesc":"Zet de letters in de juiste volgorde.","fillBlankDesc":"Kies het woord dat de zin aanvult.","memoryDesc":"Draai kaarten om en vind de paren.","start":"Start spel","next":"Volgende vraag","correct":"Goed!","wrong":"Nog niet","hint":"Hint","back":"Spellen","score":"Rondescore","done":"Goed gedaan! Ronde voltooid.","choose":"Kies het juiste antwoord","lang":"Taal","xp":"XP","skills":"Vaardigheden","stats":"Jouw statistieken","gamesPlayed":"Spellen","questions":"Vragen","accuracy":"Nauwkeurigheid","best":"Beste score","badges":"Prestaties","unlocked":"vrijgespeeld","newBadge":"Nieuwe prestatie!","answered":"Antwoord opgeslagen."},\n  ro: {"title":"JUBA LISAN","subtitle":"Învață prin joc. Progresează în fiecare zi.","points":"Puncte","streak":"Serie","level":"Nivel","games":"Jocuri educative","daily":"Provocarea zilei","dailyDesc":"O provocare zilnică pentru XP și pentru a-ți construi rutina.","wordMatch":"Potrivește cuvintele","quickChoice":"Alegere rapidă","contextQuest":"Misiune de context","sentenceBuilder":"Construiește propoziția","listenChoose":"Ascultă și alege","listeningDetective":"Detectiv de ascultare","spelling":"Provocare de ortografie","memory":"Cărți de memorie","wordMatchDesc":"Potrivește fiecare cuvânt cu traducerea corectă.","quickChoiceDesc":"Alege înainte să expire timpul.","contextQuestDesc":"Alege răspunsul natural pentru situație.","sentenceBuilderDesc":"Aranjează cuvintele într-o propoziție corectă.","listenChooseDesc":"Ascultă cuvântul și alege-l.","listeningDetectiveDesc":"Ascultă o propoziție și identifică detaliul esențial.","spellingDesc":"Scrie cuvântul cerut pe baza indiciului.","wordScramble":"Litere amestecate","fillBlank":"Completează spațiul","wordScrambleDesc":"Rearanjează literele pentru a găsi cuvântul.","fillBlankDesc":"Alege cuvântul care completează propoziția.","memoryDesc":"Descoperă cărțile și potrivește perechile.","start":"Începe jocul","next":"Următoarea întrebare","correct":"Corect!","wrong":"Nu încă","hint":"Indiciu","back":"Jocuri","score":"Scorul rundei","done":"Bravo! Runda s-a încheiat.","choose":"Alege răspunsul corect","lang":"Limbă","xp":"XP","skills":"Abilități","stats":"Statisticile tale","gamesPlayed":"Jocuri","questions":"Întrebări","accuracy":"Precizie","best":"Cel mai bun scor","badges":"Realizări","unlocked":"deblocat","newBadge":"Realizare nouă!","answered":"Răspuns înregistrat."},\n  ru: {"title":"JUBA LISAN","subtitle":"Учись играя. Становись лучше каждый день.","points":"Очки","streak":"Серия","level":"Уровень","games":"Обучающие игры","daily":"Задание дня","dailyDesc":"Одно задание каждый день, чтобы получать XP и формировать привычку.","wordMatch":"Сопоставление слов","quickChoice":"Быстрый выбор","contextQuest":"Контекстная миссия","sentenceBuilder":"Составление предложений","listenChoose":"Слушай и выбирай","listeningDetective":"Детектив на слух","spelling":"Орфографический вызов","memory":"Карточки памяти","wordMatchDesc":"Сопоставь слово с правильным переводом.","quickChoiceDesc":"Выбери ответ до окончания времени.","contextQuestDesc":"Выбери естественный ответ для ситуации.","sentenceBuilderDesc":"Расставь слова в правильном порядке.","listenChooseDesc":"Послушай слово и выбери его.","listeningDetectiveDesc":"Послушай предложение и найди ключевую деталь.","spellingDesc":"Введи слово по подсказке.","wordScramble":"Перемешанные буквы","fillBlank":"Заполни пропуск","wordScrambleDesc":"Расставь буквы, чтобы восстановить слово.","fillBlankDesc":"Выбери слово, которое завершает предложение.","memoryDesc":"Открывай карточки и находи пары.","start":"Начать игру","next":"Следующий вопрос","correct":"Правильно!","wrong":"Почти","hint":"Подсказка","back":"Игры","score":"Счёт раунда","done":"Отлично! Раунд завершён.","choose":"Выбери правильный ответ","lang":"Язык","xp":"XP","skills":"Навыки","stats":"Твоя статистика","gamesPlayed":"Игры","questions":"Вопросы","accuracy":"Точность","best":"Лучший результат","badges":"Достижения","unlocked":"открыто","newBadge":"Новое достижение!","answered":"Ответ сохранён."},\n} as const
