    ...
    <main className="min-h-screen bg-[var(--juba-bg)] px-4 py-5 text-[var(--juba-text)] sm:px-7 lg:px-10">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="juba-card rounded-[28px] p-6 sm:p-9">
          ...
          {masteryReviewMode && <div className="mb-5 rounded-2xl border border-[var(--juba-primary)] bg-[var(--juba-primary-soft)] p-4"><div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-xs font-bold uppercase tracking-[.12em] text-[var(--juba-muted)]">{t('masteryReviewSession')}</p><p className="mt-1 text-sm font-semibold">{t('masteryReviewProgress', { count: masteryReviewCompleted })}</p></div><button type="button" onClick={finishMasteryReview} className="rounded-full border border-[var(--juba-border)] bg-[var(--juba-surface)] px-4 py-2 text-xs font-bold">{t('masteryReviewFinish')}</button></div></div>}
          {masteryReviewImproved && <div className="mb-5 rounded-2xl border border-[var(--juba-border)] bg-[var(--juba-warm-soft)] p-4"><p className="font-extrabold">{t('masteryReviewImproved')}</p><p className="mt-1 text-sm font-medium text-[var(--juba-muted)]">{t('masteryReviewImprovedDesc')}</p><button type="button" onClick={() => setMasteryReviewImproved(false)} className="mt-3 rounded-full border border-[var(--juba-border)] bg-[var(--juba-surface)] px-4 py-2 text-xs font-bold">{t('masteryReviewFinish')}</button></div>}
