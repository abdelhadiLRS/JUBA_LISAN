...
export default function LessonPage() {
  ...
  const submitAnswer = async () => {
    ...
    try {
      ...
      setExercises((prev) => prev.map((item) => item.id === exercise.id ? { ...item, ...result } : item)); setAnswer('')
