...
interface LessonMasterySnapshot { total_exercises: number; attempted_exercises: number; mastered_exercises: number; learning_exercises: number; struggling_exercises: number; unseen_exercises: number; average_mastery_score: number; attempt_rate: number; mastery_rate: number; covered_variants: number }
...
export default function LessonPage() {
  ...
  const openMasteryCandidate = async () => {
    ...
    try {
      const next = await fetchNextMasteryExercise(lesson.id)
      if (!next) {
        setMasteryNext(null)
