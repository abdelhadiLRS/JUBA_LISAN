...
export default function MicButton({ status, onStart, onStop }: Props) {
  ...
  if (status === 'ready') return <button onClick={onStart} className="rounded-[14px] border border-[#5862e2] bg-[#5862e2] px-8 py-3 text-xs font-bold tracking-widest text-white uppercase shadow-[0_5px_0_#373fb8] transition-transform hover:-translate-y-px"> {t('start')}</button>
